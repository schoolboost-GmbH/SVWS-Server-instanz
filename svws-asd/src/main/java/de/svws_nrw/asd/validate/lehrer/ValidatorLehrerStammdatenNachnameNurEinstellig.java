 ...
 */
public final class ValidatorLehrerStammdatenNachnameNurEinstellig extends Validator {
	 ...
	 */
	public ValidatorLehrerStammdatenNachnameNurEinstellig(final @NotNull LehrerStammdaten daten,
	...
	protected boolean pruefe() {
		...
		if ((daten.nachname == null) || (daten.nachname.length() == 0) || daten.nachname.isBlank()) {

...
| Eingabe                          | Aktion |
|----------------------------------|--------|
| Enter / Leertaste | Selektiert die fokussierte Option (falls eine fokussiert ist) |
| Tab | Selektiert die fokussierte Option (falls eine fokussiert ist) und schließt das Dropdown |

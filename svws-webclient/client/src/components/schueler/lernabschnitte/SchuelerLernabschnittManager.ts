...
export class SchuelerLernabschnittManager {
	...
	/**
	 * Initialisiert die internen Datenstrukturen für die Leistungsdaten
	 *
	...
	/**
	 * Initialisiert die internen Datenstrukturen für die Förderschwerpunkt und führt dabei
	...
	/**
	 * Initialisiert die internen Datenstrukturen für die Jahrgänge und führt dabei
	 * eine Sortierung der internen Liste aus.
	 *
	...
	/**
	 * Initialisiert die internen Datenstrukturen für die Klassen und führt dabei
	 * eine Sortierung der internen Liste aus.
	 *
	...
	/**
	 * Initialisiert die internen Datenstrukturen für die Kurse und führt dabei
	 * eine Sortierung der internen Liste aus.
	 *
	...
	/**
	 * Fügt einen Leistungsdatensatz in die interne Map ein.
	 *
	...
	/**
	 * Gibt die Liste der aktiven Lehrer zurück.
	 *
	...
	/**
	 * Gibt die Liste der aktiven und sichtbaren Lehrer zurück.
	 *

<template>
	<div class="flex flex-col gap-4">
		<svws-ui-table :clicked="auswahl" clickable @update:clicked="gotoEintrag" :items="stundenplanManager().pausenzeitGetMengeAsList()" :columns :selectable="!readonly" v-model="selected" class="max-w-128 min-w-96" scroll>
		...
		<ui-card v-if="!readonly" icon="i-ri-add-line" title="Alle Pausenzeiten erstellen" :is-open="actionPausenzeiten" @update:is-open="(isOpen) => actionPausenzeiten = isOpen">

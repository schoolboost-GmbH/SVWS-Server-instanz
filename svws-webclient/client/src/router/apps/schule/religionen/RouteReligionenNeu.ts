...
import type { ReligionenNeuProps } from "~/components/schule/kataloge/religionen/SReligionenNeuProps";
...
const SReligionenNeu = () => import("~/components/schule/kataloge/religionen/SReligionenNeu.vue");

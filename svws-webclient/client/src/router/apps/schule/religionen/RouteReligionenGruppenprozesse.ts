...
import { routeReligionen } from "~/router/apps/schule/religionen/RouteReligionen";
import type { RouteReligionen } from "~/router/apps/schule/religionen/RouteReligionen";
import { ReligionenGruppenprozesseProps } from "~/components/schule/kataloge/religionen/gruppenprozesse/SReligionenGruppenprozesseProps";

const SReligionenGruppenprozesse = () => import("~/components/schule/kataloge/religionen/gruppenprozesse/SReligionenGruppenprozesse.vue");

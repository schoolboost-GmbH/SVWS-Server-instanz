...
import type { ReligionenDatenProps } from "~/components/schule/kataloge/religionen/daten/SReligionenDatenProps";
import { api } from "~/router/Api";
import { routeReligionen, type RouteReligionen } from "~/router/apps/schule/religionen/RouteReligionen";

const SReligionenDaten = () => import("~/components/schule/kataloge/religionen/daten/SReligionenDaten.vue");

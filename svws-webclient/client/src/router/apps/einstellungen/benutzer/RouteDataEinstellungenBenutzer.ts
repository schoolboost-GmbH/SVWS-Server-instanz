...
const defaultState = <RouteStateEinstellungenBenutzer> {
	auswahl: undefined,
	...
	daten: undefined,
	view: routeEinstellungenBenutzerDaten,
};


export class RouteDataEinstellungenBenutzer extends RouteData<RouteStateEinstellungenBenutzer> {

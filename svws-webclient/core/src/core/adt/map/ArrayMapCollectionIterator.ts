...
export function cast_de_svws_nrw_core_adt_map_ArrayMapCollectionIterator<K, V>(obj: unknown): ArrayMapCollectionIterator<K, V> {
	return obj as ArrayMapCollectionIterator<K, V>;
}

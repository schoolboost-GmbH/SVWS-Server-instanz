...
import { cast_java_lang_Comparable } from '../../../java/lang/Comparable';
...
import { ClassCastException } from '../../../java/lang/ClassCastException';
...
export class AVLMap<K, V> extends JavaObject implements NavigableMap<K, V> {
	...
	public constructor(__param0?: Comparator<K> | SortedMap<K, V>) {
		...
		} else if (((__param0 !== undefined) && ((__param0 instanceof JavaObject) && (__param0.isTranspiledInstanceOf('java.util.SortedMap'))) || (__param0 === null))) {

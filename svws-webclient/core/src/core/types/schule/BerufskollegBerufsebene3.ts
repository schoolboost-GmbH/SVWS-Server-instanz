...
export class BerufskollegBerufsebene3 extends JavaEnum<BerufskollegBerufsebene3> {

	/** an array containing all values of this enumeration */
	static readonly all_values_by_ordinal: Array<BerufskollegBerufsebene3> = [];

	/** an array containing all values of this enumeration indexed by their name*/
	static readonly all_values_by_name: Map<string, BerufskollegBerufsebene3> = new Map<string, BerufskollegBerufsebene3>();
	 ...
	 */
	private static readonly _ebenen: HashMap<string, BerufskollegBerufsebene3> = new HashMap<string, BerufskollegBerufsebene3>();
	...
	private static getMapBerufsebenenByKuerzel(): HashMap<string, BerufskollegBerufsebene3> {
		if (BerufskollegBerufsebene3._ebenen.size() === 0) {
			for (const s of BerufskollegBerufsebene3.values()) {
				if (s.daten !== null)
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.types.schule.BerufskollegBerufsebene3';
	}

	isTranspiledInstanceOf(name: string): boolean {
		return ['de.svws_nrw.core.types.schule.BerufskollegBerufsebene3', 'java.lang.Enum', 'java.lang.Comparable'].includes(name);
	}

	public static class = new Class<BerufskollegBerufsebene3>('de.svws_nrw.core.types.schule.BerufskollegBerufsebene3');

}

export function cast_de_svws_nrw_core_types_schule_BerufskollegBerufsebene3(obj: unknown): BerufskollegBerufsebene3 {

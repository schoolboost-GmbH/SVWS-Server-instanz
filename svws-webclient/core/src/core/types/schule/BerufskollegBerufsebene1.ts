...
export class BerufskollegBerufsebene1 extends JavaEnum<BerufskollegBerufsebene1> {
	...
	static readonly all_values_by_name: Map<string, BerufskollegBerufsebene1> = new Map<string, BerufskollegBerufsebene1>();
	 ...
	 */
	private static readonly _ebenen: HashMap<string, BerufskollegBerufsebene1> = new HashMap<string, BerufskollegBerufsebene1>();
	...
	public static class = new Class<BerufskollegBerufsebene1>('de.svws_nrw.core.types.schule.BerufskollegBerufsebene1');

...
export class HerkunftSchulform extends JavaEnum<HerkunftSchulform> {
	 ...
	 */
	private static readonly _ebenen: HashMap<string, HerkunftSchulform> = new HashMap<string, HerkunftSchulform>();
	 ...
	 */
	private static getMapByKuerzel(): HashMap<string, HerkunftSchulform> {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.types.schueler.HerkunftSchulform';
	}
	...
	public static class = new Class<HerkunftSchulform>('de.svws_nrw.core.types.schueler.HerkunftSchulform');

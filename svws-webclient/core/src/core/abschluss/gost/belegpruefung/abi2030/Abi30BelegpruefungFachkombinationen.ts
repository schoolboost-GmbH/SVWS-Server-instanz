...
export class Abi30BelegpruefungFachkombinationen extends GostBelegpruefung {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2030.Abi30BelegpruefungFachkombinationen';
	}
...
export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2030_Abi30BelegpruefungFachkombinationen(obj: unknown): Abi30BelegpruefungFachkombinationen {
	return obj as Abi30BelegpruefungFachkombinationen;
}

...
export class Abi30BelegpruefungGesellschaftswissenschaftenUndReligion extends GostBelegpruefung {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.core.abschluss.gost.belegpruefung.abi2030.Abi30BelegpruefungGesellschaftswissenschaftenUndReligion';
	}
...
export function cast_de_svws_nrw_core_abschluss_gost_belegpruefung_abi2030_Abi30BelegpruefungGesellschaftswissenschaftenUndReligion(obj: unknown): Abi30BelegpruefungGesellschaftswissenschaftenUndReligion {
	return obj as Abi30BelegpruefungGesellschaftswissenschaftenUndReligion;
}

...
export class Schild3KatalogEintragPruefungsordnungOption extends JavaObject {
	...
	public static transpilerToJSON(obj: Schild3KatalogEintragPruefungsordnungOption): string {
		...
		result += '"OP_Krz" : ' + ((obj.OP_Krz === null) ? 'null' : JSON.stringify(obj.OP_Krz)) + ',';
		result += '"OP_Abgangsart_B" : ' + ((obj.OP_Abgangsart_B === null) ? 'null' : JSON.stringify(obj.OP_Abgangsart_B)) + ',';
		result += '"OP_Abgangsart_NB" : ' + ((obj.OP_Abgangsart_NB === null) ? 'null' : JSON.stringify(obj.OP_Abgangsart_NB)) + ',';
		result += '"OP_Art" : ' + ((obj.OP_Art === null) ? 'null' : JSON.stringify(obj.OP_Art)) + ',';
		result += '"OP_Typ" : ' + ((obj.OP_Typ === null) ? 'null' : JSON.stringify(obj.OP_Typ)) + ',';
		result += '"OP_Bildungsgang" : ' + ((obj.OP_Bildungsgang === null) ? 'null' : JSON.stringify(obj.OP_Bildungsgang)) + ',';
		result += '"OP_Name" : ' + ((obj.OP_Name === null) ? 'null' : JSON.stringify(obj.OP_Name)) + ',';
		result += '"OP_Kommentar" : ' + ((obj.OP_Kommentar === null) ? 'null' : JSON.stringify(obj.OP_Kommentar)) + ',';
		result += '"OP_Jahrgaenge" : ' + ((obj.OP_Jahrgaenge === null) ? 'null' : JSON.stringify(obj.OP_Jahrgaenge)) + ',';
		result += '"OP_BKIndex" : ' + ((obj.OP_BKIndex === null) ? 'null' : JSON.stringify(obj.OP_BKIndex)) + ',';
		result += '"OP_BKAnl_Typ" : ' + ((obj.OP_BKAnl_Typ === null) ? 'null' : JSON.stringify(obj.OP_BKAnl_Typ)) + ',';
		result += '"OP_Reihenfolge" : ' + ((obj.OP_Reihenfolge === null) ? 'null' : obj.OP_Reihenfolge.toString()) + ',';

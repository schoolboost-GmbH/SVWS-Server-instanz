...
export class KlausurblockungSchienenAlgorithmusGreedy7 extends KlausurblockungSchienenAlgorithmusAbstract {
	...
	public static class = new Class<KlausurblockungSchienenAlgorithmusGreedy7>('de.svws_nrw.core.utils.gost.klausurplanung.KlausurblockungSchienenAlgorithmusGreedy7');

...
export class LehrerFachrichtungKatalogEintrag extends CoreTypeData {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.asd.data.lehrer.LehrerFachrichtungKatalogEintrag';
	}
	...
	public static transpilerFromJSON(json: string): LehrerFachrichtungKatalogEintrag {
		...
		const result = new LehrerFachrichtungKatalogEintrag();
		if (obj.id === undefined)
	...
	public static transpilerToJSON(obj: LehrerFachrichtungKatalogEintrag): string {
		let result = '{';
	...
	public static transpilerToJSONPatch(obj: Partial<LehrerFachrichtungKatalogEintrag>): string {
		let result = '{';
		if (obj.id !== undefined) {
			result += '"id" : ' + obj.id.toString() + ',';
		}
...
export function cast_de_svws_nrw_asd_data_lehrer_LehrerFachrichtungKatalogEintrag(obj: unknown): LehrerFachrichtungKatalogEintrag {
	return obj as LehrerFachrichtungKatalogEintrag;
}

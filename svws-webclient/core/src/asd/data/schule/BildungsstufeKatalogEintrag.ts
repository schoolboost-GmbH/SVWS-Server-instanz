...
export class BildungsstufeKatalogEintrag extends CoreTypeDataNurSchulformen {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.asd.data.schule.BildungsstufeKatalogEintrag';
	}
	...
	public static transpilerFromJSON(json: string): BildungsstufeKatalogEintrag {
		...
		const result = new BildungsstufeKatalogEintrag();
	...
	public static transpilerToJSON(obj: BildungsstufeKatalogEintrag): string {
		let result = '{';
		result += '"schulformen" : [ ';
	...
	public static transpilerToJSONPatch(obj: Partial<BildungsstufeKatalogEintrag>): string {
		let result = '{';
		if (obj.schulformen !== undefined) {
			result += '"schulformen" : [ ';
			for (let i = 0; i < obj.schulformen.size(); i++) {
...
export function cast_de_svws_nrw_asd_data_schule_BildungsstufeKatalogEintrag(obj: unknown): BildungsstufeKatalogEintrag {
	return obj as BildungsstufeKatalogEintrag;
}

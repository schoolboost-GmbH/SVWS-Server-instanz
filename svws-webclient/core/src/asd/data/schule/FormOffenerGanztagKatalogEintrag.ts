...
export class FormOffenerGanztagKatalogEintrag extends CoreTypeDataNurSchulformen {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.asd.data.schule.FormOffenerGanztagKatalogEintrag';
	}
	...
	public static transpilerFromJSON(json: string): FormOffenerGanztagKatalogEintrag {
		...
		const result = new FormOffenerGanztagKatalogEintrag();
	...
	public static transpilerToJSON(obj: FormOffenerGanztagKatalogEintrag): string {
		let result = '{';
		result += '"schulformen" : [ ';
	...
	public static transpilerToJSONPatch(obj: Partial<FormOffenerGanztagKatalogEintrag>): string {
		let result = '{';
		if (obj.schulformen !== undefined) {
			result += '"schulformen" : [ ';
			for (let i = 0; i < obj.schulformen.size(); i++) {
...
export function cast_de_svws_nrw_asd_data_schule_FormOffenerGanztagKatalogEintrag(obj: unknown): FormOffenerGanztagKatalogEintrag {
	return obj as FormOffenerGanztagKatalogEintrag;
}

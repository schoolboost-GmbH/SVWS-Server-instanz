...
export class BetreuungsartKatalogEintrag extends CoreTypeDataNurSchulformen {
	...
	transpilerCanonicalName(): string {
		return 'de.svws_nrw.asd.data.schueler.BetreuungsartKatalogEintrag';
	}
	...
	public static transpilerFromJSON(json: string): BetreuungsartKatalogEintrag {
		...
		const result = new BetreuungsartKatalogEintrag();
	...
	public static transpilerToJSON(obj: BetreuungsartKatalogEintrag): string {
		let result = '{';
		result += '"schulformen" : [ ';
	...
	public static transpilerToJSONPatch(obj: Partial<BetreuungsartKatalogEintrag>): string {
		let result = '{';
		if (obj.schulformen !== undefined) {
			result += '"schulformen" : [ ';
			for (let i = 0; i < obj.schulformen.size(); i++) {
...
export function cast_de_svws_nrw_asd_data_schueler_BetreuungsartKatalogEintrag(obj: unknown): BetreuungsartKatalogEintrag {
	return obj as BetreuungsartKatalogEintrag;
}

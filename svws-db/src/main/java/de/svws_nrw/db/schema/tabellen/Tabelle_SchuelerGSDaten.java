...
public class Tabelle_SchuelerGSDaten extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Note_Sprachgebrauch = add("Note_Sprachgebrauch", SchemaDatentypen.INT, false)
			.setJavaComment("Note Sprachgebrauch zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Note_Lesen */
	public final SchemaTabelleSpalte col_Note_Lesen = add("Note_Lesen", SchemaDatentypen.INT, false)
			.setJavaComment("Note Lesen zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Note_Rechtschreiben */
	public final SchemaTabelleSpalte col_Note_Rechtschreiben = add("Note_Rechtschreiben", SchemaDatentypen.INT, false)
			.setJavaComment("Note Rechtschreibe zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Note_Sachunterricht */
	public final SchemaTabelleSpalte col_Note_Sachunterricht = add("Note_Sachunterricht", SchemaDatentypen.INT, false)
			.setJavaComment("Note Sachunterricht zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Note_Mathematik */
	public final SchemaTabelleSpalte col_Note_Mathematik = add("Note_Mathematik", SchemaDatentypen.INT, false)
			.setJavaComment("Note Mathematik zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Note_Englisch */
	public final SchemaTabelleSpalte col_Note_Englisch = add("Note_Englisch", SchemaDatentypen.INT, false)
			.setJavaComment("Note Englisch zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Note_KunstTextil */
	public final SchemaTabelleSpalte col_Note_KunstTextil = add("Note_KunstTextil", SchemaDatentypen.INT, false)
			.setJavaComment("Note Kunst und Textil zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Note_Musik */
	public final SchemaTabelleSpalte col_Note_Musik = add("Note_Musik", SchemaDatentypen.INT, false)
			.setJavaComment("Note Musik zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Note_Sport */
	public final SchemaTabelleSpalte col_Note_Sport = add("Note_Sport", SchemaDatentypen.INT, false)
			.setJavaComment("Note Sport zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Note_Religion */
	public final SchemaTabelleSpalte col_Note_Religion = add("Note_Religion", SchemaDatentypen.INT, false)
			.setJavaComment("Note Religion zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Durchschnittsnote_Sprache */
	public final SchemaTabelleSpalte col_Durchschnittsnote_Sprache = add("Durchschnittsnote_Sprache", SchemaDatentypen.FLOAT, false)
			.setJavaComment("Durchschnitt Sprache zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Durchschnittsnote_Einfach */
	public final SchemaTabelleSpalte col_Durchschnittsnote_Einfach = add("Durchschnittsnote_Einfach", SchemaDatentypen.FLOAT, false)
			.setJavaComment("Durschnit einfach zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Durchschnittsnote_Gewichtet */
	public final SchemaTabelleSpalte col_Durchschnittsnote_Gewichtet = add("Durchschnittsnote_Gewichtet", SchemaDatentypen.FLOAT, false)
	...
	public final SchemaTabelleSpalte col_Anrede_Klassenlehrer = add("Anrede_Klassenlehrer", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Anrede klassenlehrer zum GS-Daten-Eintrag");

	/** Die Definition der Tabellenspalte Nachname_Klassenlehrer */
	public final SchemaTabelleSpalte col_Nachname_Klassenlehrer = add("Nachname_Klassenlehrer", SchemaDatentypen.VARCHAR, false).setDatenlaenge(120)
	...
	public final SchemaTabelleSpalte col_GS_Klasse = add("GS_Klasse", SchemaDatentypen.VARCHAR, false).setDatenlaenge(15)
	...
	public final SchemaTabelleSpalte col_Geschwisterkind = add("Geschwisterkind", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerGSDaten_Schueler_FK = addForeignKey(

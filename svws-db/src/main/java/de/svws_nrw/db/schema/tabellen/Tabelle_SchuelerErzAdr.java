...
public class Tabelle_SchuelerErzAdr extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_ErzieherArt_ID = add("ErzieherArt_ID", SchemaDatentypen.BIGINT, false)
			.setJavaComment("ErziherARTID zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte Anrede1 */
	public final SchemaTabelleSpalte col_Anrede1 = add("Anrede1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("Anrede1 zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte Titel1 */
	public final SchemaTabelleSpalte col_Titel1 = add("Titel1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Titel1 zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte Name1 */
	public final SchemaTabelleSpalte col_Name1 = add("Name1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(120)
			.setJavaComment("Nachname1 zum Erzieherdatensatz PAuswG vom 21.6.2019 §5 Abs. 2");

	/** Die Definition der Tabellenspalte Vorname1 */
	public final SchemaTabelleSpalte col_Vorname1 = add("Vorname1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(80)
	...
	public final SchemaTabelleSpalte col_Anrede2 = add("Anrede2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("Anrede2 zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte Titel2 */
	public final SchemaTabelleSpalte col_Titel2 = add("Titel2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Titel2 zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte Name2 */
	public final SchemaTabelleSpalte col_Name2 = add("Name2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(120)
			.setJavaComment("Nachname2 zum Erzieherdatensatz PAuswG vom 21.6.2019 §5 Abs. 2");

	/** Die Definition der Tabellenspalte Vorname2 */
	public final SchemaTabelleSpalte col_Vorname2 = add("Vorname2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(80)
	...
	public final SchemaTabelleSpalte col_ErzStrasse = add("ErzStrasse", SchemaDatentypen.VARCHAR, false).setDatenlaenge(55)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Straße zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte ErzOrt_ID */
	public final SchemaTabelleSpalte col_ErzOrt_ID = add("ErzOrt_ID", SchemaDatentypen.BIGINT, false)
			.setJavaComment("OrtID zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte ErzStrassenname */
	public final SchemaTabelleSpalte col_ErzStrassenname = add("ErzStrassenname", SchemaDatentypen.VARCHAR, false).setDatenlaenge(55)
			.setJavaComment("Straßenname des Erzieherdatensatzes");

	/** Die Definition der Tabellenspalte ErzPLZ */
	public final SchemaTabelleSpalte col_ErzPLZ = add("ErzPLZ", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
	...
	public final SchemaTabelleSpalte col_ErzHausNr = add("ErzHausNr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Hausnummer wenn getrennt gespeichert");

	/** Die Definition der Tabellenspalte ErzOrtsteil_ID */
	public final SchemaTabelleSpalte col_ErzOrtsteil_ID = add("ErzOrtsteil_ID", SchemaDatentypen.BIGINT, false)
			.setJavaComment("OrtsteilID zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte ErzHausNrZusatz */
	public final SchemaTabelleSpalte col_ErzHausNrZusatz = add("ErzHausNrZusatz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(30)
	...
	public final SchemaTabelleSpalte col_ErzAnschreiben = add("ErzAnschreiben", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_ErzEmail = add("ErzEmail", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Email1 zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte ErzAdrZusatz */
	public final SchemaTabelleSpalte col_ErzAdrZusatz = add("ErzAdrZusatz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
	...
	public final SchemaTabelleSpalte col_Erz1StaatKrz = add("Erz1StaatKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(3)
	...
	public final SchemaTabelleSpalte col_Erz2StaatKrz = add("Erz2StaatKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(3)
			.setConverter(NationalitaetenConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Staatangehörigkeit2 zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte ErzEmail2 */
	public final SchemaTabelleSpalte col_ErzEmail2 = add("ErzEmail2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Email2 zum Erzieherdatensatz");

	/** Die Definition der Tabellenspalte Erz1ZusatzNachname */
	public final SchemaTabelleSpalte col_Erz1ZusatzNachname = add("Erz1ZusatzNachname", SchemaDatentypen.VARCHAR, false).setDatenlaenge(30)
	...
	public final SchemaTabelleSpalte col_Erz2ZusatzNachname = add("Erz2ZusatzNachname", SchemaDatentypen.VARCHAR, false).setDatenlaenge(30)
			.setVeraltet(SchemaRevisionen.REV_2)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerErzAdr_Credentials_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerErzAdr_ErzieherArt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerErzAdr_Ort_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerErzAdr_Ortsteil_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerErzAdr_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerErzAdr_Staat1_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerErzAdr_Staat2_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_SchuelerErzAdr_IDX1 = addIndex("SchuelerErzAdr_IDX1",
			col_Schueler_ID
	);

...
public class Tabelle_EigeneSchule_Zertifikate extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Fach = add("Fach", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Fachbezeichnung für das Zertifikat");

	/** Die Definition der Tabellenspalte Formatvorlage */
	public final SchemaTabelleSpalte col_Formatvorlage = add("Formatvorlage", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Formatforlage für das Zertifikat");


	/** Die Definition des Unique-Index EigeneSchule_Zertifikate_UC1 */
	public final SchemaTabelleUniqueIndex unique_EigeneSchule_Zertifikate_UC1 = addUniqueIndex("EigeneSchule_Zertifikate_UC1",
			col_Kuerzel);

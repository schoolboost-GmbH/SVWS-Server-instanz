...
public class Tabelle_SchildFilter extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Art = add("Art", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setJavaComment("Art des Filters");

	/** Die Definition der Tabellenspalte Name */
	public final SchemaTabelleSpalte col_Name = add("Name", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setNotNull()
			.setJavaComment("Bezeichnender Kurztext des Filters");

	/** Die Definition der Tabellenspalte Beschreibung */
	public final SchemaTabelleSpalte col_Beschreibung = add("Beschreibung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Beschreibung zum Filter");

	/** Die Definition der Tabellenspalte Tabellen */
	public final SchemaTabelleSpalte col_Tabellen = add("Tabellen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Tabellen die im Filter vorkommen");

	/** Die Definition der Tabellenspalte ZusatzTabellen */
	public final SchemaTabelleSpalte col_ZusatzTabellen = add("ZusatzTabellen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Zusätzliche Tabellen die im Filtervorkommen");

	/** Die Definition der Tabellenspalte Bedingung */
	public final SchemaTabelleSpalte col_Bedingung = add("Bedingung", SchemaDatentypen.TEXT, false)
			.setJavaComment("SQL-Text des Filters");

	/** Die Definition der Tabellenspalte BedingungKlartext */
	public final SchemaTabelleSpalte col_BedingungKlartext = add("BedingungKlartext", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleUniqueIndex unique_SchildFilter_UC1 = addUniqueIndex("SchildFilter_UC1",
			col_Name
	);

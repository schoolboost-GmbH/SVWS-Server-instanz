...
public class Tabelle_DavRessources extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_DavRessourceCollection_ID = add("DavRessourceCollection_ID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
			.setJavaComment("Id der Ressourcensammlung, deren Teil diese Ressource ist");

	/** Die Definition der Tabellenspalte UID */
	public final SchemaTabelleSpalte col_UID = add("UID", SchemaDatentypen.VARCHAR, false).setDatenlaenge(120)
			.setNotNull()
			.setJavaComment("Die UID der Ressource");

	/** Die Definition der Tabellenspalte lastModified */
	public final SchemaTabelleSpalte col_lastModified = add("lastModified", SchemaDatentypen.DATETIME, false)
			.setNotNull()
			.setDatenlaenge(3)
	...
	public final SchemaTabelleSpalte col_KalenderTyp = add("KalenderTyp", SchemaDatentypen.VARCHAR, false).setDatenlaenge(120)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_KalenderStart = add("KalenderStart", SchemaDatentypen.DATETIME, false)
			.setNotNull()
			.setDatenlaenge(3)
			.setConverter(DatumUhrzeitConverter.class)
	...
	public final SchemaTabelleSpalte col_KalenderEnde = add("KalenderEnde", SchemaDatentypen.DATETIME, false)
			.setNotNull()
			.setDatenlaenge(3)
			.setConverter(DatumUhrzeitConverter.class)
	...
	public final SchemaTabelleSpalte col_ressource = add("ressource", SchemaDatentypen.LONGBLOB, false)
			.setNotNull()
			.setJavaComment("Die Daten der Ressource");

	/** Die Definition der Tabellenspalte geloeschtam */
	public final SchemaTabelleSpalte col_geloeschtam = add("geloeschtam", SchemaDatentypen.DATETIME, false)
			.setDatenlaenge(3)
			.setConverter(DatumUhrzeitConverter.class)
	...
	public final SchemaTabelleFremdschluessel fk_DavRessources_Collection_FK = addForeignKey(

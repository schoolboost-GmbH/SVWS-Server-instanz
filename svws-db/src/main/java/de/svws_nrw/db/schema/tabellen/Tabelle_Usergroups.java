...
public class Tabelle_Usergroups extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_UG_ID = add("UG_ID", SchemaDatentypen.BIGINT, true)
			.setNotNull()
			.setJavaComment("ID der Benutzergruppe");

	/** Die Definition der Tabellenspalte UG_Bezeichnung */
	public final SchemaTabelleSpalte col_UG_Bezeichnung = add("UG_Bezeichnung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(64)
			.setJavaComment("Bezeichnung der Benutzergruppe");

	/** Die Definition der Tabellenspalte UG_Kompetenzen */
	public final SchemaTabelleSpalte col_UG_Kompetenzen = add("UG_Kompetenzen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Kompetenzen der Benutzergrupppe in vorgegebenen Zahlerwerten");

	/** Die Definition der Tabellenspalte UG_Nr */
	public final SchemaTabelleSpalte col_UG_Nr = add("UG_Nr", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleUniqueIndex unique_Usergroups_UC1 = addUniqueIndex("Usergroups_UC1",
			col_UG_Bezeichnung
	);

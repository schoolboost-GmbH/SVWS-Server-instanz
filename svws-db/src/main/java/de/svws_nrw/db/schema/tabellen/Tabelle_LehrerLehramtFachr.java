...
public class Tabelle_LehrerLehramtFachr extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_FachrKrz = add("FachrKrz", SchemaDatentypen.VARCHAR, true).setDatenlaenge(10)
			.setJavaComment("Fachrichtungskürzel");

	/** Die Definition der Tabellenspalte FachrAnerkennungKrz */
	public final SchemaTabelleSpalte col_FachrAnerkennungKrz = add("FachrAnerkennungKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
	...
	public final SchemaTabelleFremdschluessel fk_LehrerLehramtFachr_Lehrer_FK = addForeignKey(

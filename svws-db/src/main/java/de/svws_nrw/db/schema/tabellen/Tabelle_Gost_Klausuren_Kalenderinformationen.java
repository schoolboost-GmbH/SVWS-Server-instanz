...
public class Tabelle_Gost_Klausuren_Kalenderinformationen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Startdatum = add("Startdatum", SchemaDatentypen.DATE, false)
	...
	public final SchemaTabelleSpalte col_Enddatum = add("Enddatum", SchemaDatentypen.DATE, false)
			.setConverter(DatumConverter.class)
	...
	public final SchemaTabelleSpalte col_IstSperrtermin = add("IstSperrtermin", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()

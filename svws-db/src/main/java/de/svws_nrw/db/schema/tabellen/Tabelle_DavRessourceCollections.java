...
public class Tabelle_DavRessourceCollections extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Anzeigename = add("Anzeigename", SchemaDatentypen.VARCHAR, false).setDatenlaenge(120)
			.setNotNull()
			.setJavaComment("Der Anzeigename der Ressourcensammlung");

	/** Die Definition der Tabellenspalte Beschreibung */
	public final SchemaTabelleSpalte col_Beschreibung = add("Beschreibung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2047)
	...
	public final SchemaTabelleFremdschluessel fk_DavRessourceCollection_Benutzer_FK = addForeignKey(

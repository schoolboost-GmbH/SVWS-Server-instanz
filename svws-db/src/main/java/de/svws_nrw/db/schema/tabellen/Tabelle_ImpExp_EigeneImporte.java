...
public class Tabelle_ImpExp_EigeneImporte extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Title = add("Title", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaComment("Bezeichnung des Schemas");

	/** Die Definition der Tabellenspalte DelimiterChar */
	public final SchemaTabelleSpalte col_DelimiterChar = add("DelimiterChar", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setJavaComment("Enthält das Trennzeichen für den Import");

	/** Die Definition der Tabellenspalte TextQuote */
	public final SchemaTabelleSpalte col_TextQuote = add("TextQuote", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setJavaComment("Texttrennzeichen");

	/** Die Definition der Tabellenspalte SkipLines */
	public final SchemaTabelleSpalte col_SkipLines = add("SkipLines", SchemaDatentypen.SMALLINT, false)
			.setDefault("0")
			.setJavaComment("externen Textimport");

	/** Die Definition der Tabellenspalte DateFormat */
	public final SchemaTabelleSpalte col_DateFormat = add("DateFormat", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Format der Datumswerte");

	/** Die Definition der Tabellenspalte BooleanTrue */
	public final SchemaTabelleSpalte col_BooleanTrue = add("BooleanTrue", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("externen Textimport");

	/** Die Definition der Tabellenspalte AbkWeiblich */
	public final SchemaTabelleSpalte col_AbkWeiblich = add("AbkWeiblich", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Abkürzung für weiblich");

	/** Die Definition der Tabellenspalte AbkMaennlich */
	public final SchemaTabelleSpalte col_AbkMaennlich = add("AbkMaennlich", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Abkürzung für männlich");

	/** Die Definition der Tabellenspalte MainTable */
	public final SchemaTabelleSpalte col_MainTable = add("MainTable", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaComment("externen Textimport");

	/** Die Definition der Tabellenspalte InsertMode */
	public final SchemaTabelleSpalte col_InsertMode = add("InsertMode", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setJavaComment("externen Textimport");

	/** Die Definition der Tabellenspalte LookupTableDir */
	public final SchemaTabelleSpalte col_LookupTableDir = add("LookupTableDir", SchemaDatentypen.VARCHAR, false).setDatenlaenge(250)
			.setJavaComment("externen Textimport");

	/** Die Definition der Tabellenspalte SchuelerIDMode */
	public final SchemaTabelleSpalte col_SchuelerIDMode = add("SchuelerIDMode", SchemaDatentypen.VARCHAR, false).setDatenlaenge(4)
			.setJavaComment("externen Textimport");

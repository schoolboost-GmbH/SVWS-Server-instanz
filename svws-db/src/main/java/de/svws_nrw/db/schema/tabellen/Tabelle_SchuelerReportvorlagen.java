...
public class Tabelle_SchuelerReportvorlagen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_User_ID = add("User_ID", SchemaDatentypen.BIGINT, true)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_Reportvorlage = add("Reportvorlage", SchemaDatentypen.VARCHAR, true).setDatenlaenge(255)
			.setJavaComment("Pfad zur Reportvorlage");

	/** Die Definition der Tabellenspalte Schueler_IDs */
	public final SchemaTabelleSpalte col_Schueler_IDs = add("Schueler_IDs", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerReportvorlagen_Benutzer_FK = addForeignKey(

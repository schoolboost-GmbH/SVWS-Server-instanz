...
public class Tabelle_DavRessourceCollectionsACL extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_RessourceCollection_ID = add("RessourceCollection_ID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
			.setJavaComment("Die ID der RessourceCollection dieses ACL-Eintrags");

	/** Die Definition der Tabellenspalte Berechtigungen */
	public final SchemaTabelleSpalte col_Typ = add("berechtigungen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setNotNull()
			.setJavaComment(
	...
	public final SchemaTabelleFremdschluessel fk_DavRessourceCollectionsACL_Benutzer_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_DavRessourceCollectionsACL_RessourceCollection_FK = addForeignKey(

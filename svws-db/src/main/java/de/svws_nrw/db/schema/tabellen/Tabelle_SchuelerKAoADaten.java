...
public class Tabelle_SchuelerKAoADaten extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_KategorieID = add("KategorieID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_MerkmalID = add("MerkmalID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_ZusatzmerkmalID = add("ZusatzmerkmalID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_AnschlussoptionID = add("AnschlussoptionID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_BerufsfeldID = add("BerufsfeldID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_SBO_Ebene4ID = add("SBO_Ebene4ID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerKAoADaten_Abschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerKAoADaten_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerKAoADaten_Kategorie_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerKAoADaten_Merkmal_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerKAoADaten_Zusatzmerkmal_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerKAoADaten_Anschlussoption_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerKAoADaten_Berufsfeld_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerKAoADaten_SBO_Ebene4_FK = addForeignKey(

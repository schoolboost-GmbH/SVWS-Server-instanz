...
public class Tabelle_Stundenplan_Unterricht extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Wochentyp = add("Wochentyp", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
			.setJavaComment("Gibt an, ob es sich um einen Eintrag für jede Woche handelt (0) oder ob es sich um einen unterschiedlichen (!) Eintrag"
					+ " für eine A- bzw. B-Wochen (1 bzw. 2) handelt");
	...
	public final SchemaTabelleFremdschluessel fk_Stundenplan_Unterricht_EigeneSchule_Faecher_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Stundenplan_Unterricht_Kurse_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Stundenplan_Unterricht_Stundenplan_Zeitraster_FK = addForeignKey(
	...
	public Tabelle_Stundenplan_Unterricht() {
		...
		setJavaComment("Enthält die Zuordnung der Unterrichte (Kurs, Fach) zu einem Zeitraster-Eintrag. Über das Zeitraster ist diese Zuordnung auch immer"
				+ " eindeutig einem Stundenplan zugeordnet. Die Zuordnung von Lehrern und Räumen erfolgt über die Tabellen Stundenplan_UnterrichtLehrer und"

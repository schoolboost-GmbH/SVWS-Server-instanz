...
/**
 * Diese Klasse beinhaltet die Schema-Definition für die Tabelle K_Vermerkart.
 */
public class Tabelle_K_Vermerkart extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_ID = add("ID", SchemaDatentypen.BIGINT, true)
			.setNotNull()
			.setJavaComment("ID der Vermerkart");
	...
	public final SchemaTabelleSpalte col_Sichtbar = add("Sichtbar", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			...
			.setJavaComment("Sichbarkeit der Vermerkart");
	...
	public final SchemaTabelleSpalte col_Aenderbar = add("Aenderbar", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
			.setJavaComment("Änderbarkeit der Vermerkart");
	...
	/** Die Definition des Unique-Index K_Vermerkart_UC1 */
	public final SchemaTabelleUniqueIndex unique_K_Vermerkart_UC1 = addUniqueIndex("K_Vermerkart_UC1",
			col_Bezeichnung
	);


	/**
	 * Erstellt die Schema-Defintion für die Tabelle K_Vermerkart.
	 */

...
public class Tabelle_AllgAdrAnsprechpartner extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Abteilung = add("Abteilung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
	...
	public final SchemaTabelleSpalte col_Titel = add("Titel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(15)
	...
	public final SchemaTabelleFremdschluessel fk_AllgAdrAnsprechpartner_Adr_FK = addForeignKey(

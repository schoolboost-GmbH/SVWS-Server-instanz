...
public class Tabelle_UV_StundenplanErgebnisse_Unterricht_Zeitraster extends SchemaTabelle {
	...
	public SchemaTabelleSpalte col_ZeitrasterEintrag_ID = add("ZeitrasterEintrag_ID", SchemaDatentypen.BIGINT, true)
			.setNotNull()
	...
	public SchemaTabelleFremdschluessel fk_UVStundenplanErgUntZr_UVStundenplanErg_FK = addForeignKey(
	...
	public SchemaTabelleFremdschluessel fk_UVStundenplanErgUntZr_UVUnt_FK = addForeignKey(
	...
	public SchemaTabelleFremdschluessel fk_UVStundenplanErgUntZr_UVZrEintraege_FK = addForeignKey(
	...
	public SchemaTabelleUniqueIndex unique_StundenplanErgebnisse_Unterricht_Zeitraster_UC1 = addUniqueIndex("UVStundenplanErgebnisse_Unterricht_Zeitraster_UC1",

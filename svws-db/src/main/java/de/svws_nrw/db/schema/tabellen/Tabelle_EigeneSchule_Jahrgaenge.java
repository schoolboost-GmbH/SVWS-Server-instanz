...
public class Tabelle_EigeneSchule_Jahrgaenge extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_InternKrz = add("InternKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("Ein Kürzel für den Jahrgang, welches bei der Darstellung genutzt wird");

	/** Die Definition der Tabellenspalte GueltigVon */
	public final SchemaTabelleSpalte col_GueltigVon = add("GueltigVon", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_GueltigBis = add("GueltigBis", SchemaDatentypen.BIGINT, false)
			.setJavaComment(
	...
	public final SchemaTabelleSpalte col_ASDBezeichnung = add("ASDBezeichnung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
	...
	public final SchemaTabelleSpalte col_IstChronologisch = add("IstChronologisch", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_Spaltentitel = add("Spaltentitel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_SekStufe = add("SekStufe", SchemaDatentypen.VARCHAR, false).setDatenlaenge(6)
	...
	public final SchemaTabelleSpalte col_SGL = add("SGL", SchemaDatentypen.VARCHAR, false).setDatenlaenge(3)
	...
	public final SchemaTabelleSpalte col_Restabschnitte = add("Restabschnitte", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Folgejahrgang_ID = add("Folgejahrgang_ID", SchemaDatentypen.BIGINT, false)
			.setJavaComment(
	...
	public final SchemaTabelleFremdschluessel fk_EigeneSchule_Jahrgaenge_GueltigVon_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_EigeneSchule_Jahrgaenge_GueltigBis_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_EigeneSchule_Jahrgaenge_UC1 = addUniqueIndex("EigeneSchule_Jahrgaenge_UC1",
			col_InternKrz);

	/** Die Definition des Non-Unique-Index EigeneSchule_Jahrgaenge_IDX_ASDJahrgang */
	public final SchemaTabelleIndex index_EigeneSchule_Jahrgaenge_IDX_ASDJahrgang = addIndex("EigeneSchule_Jahrgaenge_IDX_ASDJahrgang",
			col_ASDJahrgang)

...
public class Tabelle_Stundentafel_Faecher extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_EpochenUnterricht = add("EpochenUnterricht", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_LehrerKrz = add("LehrerKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleFremdschluessel fk_StundentafelFaecher_Faecher_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_StundentafelFaecher_Stdtafel_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_Stundentafel_Faecher_UC1 = addUniqueIndex("Stundentafel_Faecher_UC1",
			col_Fach_ID,
			col_Stundentafel_ID
	);

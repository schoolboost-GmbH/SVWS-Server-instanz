...
public class Tabelle_EigeneSchule_Abteilungen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_AbteilungsLeiter_ID = add("AbteilungsLeiter_ID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_Raum = add("Raum", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
	...
	public final SchemaTabelleSpalte col_Durchwahl = add("Durchwahl", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
	...
	public final SchemaTabelleSpalte col_AbteilungsLeiter = add("AbteilungsLeiter", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
	...
	public final SchemaTabelleFremdschluessel fk_EigeneSchule_Abteilungen_Leiter_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_EigeneSchule_Abteilungen_Schuljahreabschnitt_FK = addForeignKey(

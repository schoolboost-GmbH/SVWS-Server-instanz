...
public class Tabelle_SchuelerFoerderempfehlungen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_GU_ID = add("GU_ID", SchemaDatentypen.VARCHAR, true).setDatenlaenge(40)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_DatumAngelegt = add("DatumAngelegt", SchemaDatentypen.DATE, false)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_DatumAenderungSchild = add("DatumAenderungSchild", SchemaDatentypen.DATETIME, false)
	...
	public final SchemaTabelleSpalte col_DatumAenderungSchildWeb = add("DatumAenderungSchildWeb", SchemaDatentypen.DATETIME, false)
			.setJavaComment("Änderungsdatum in SchildWeb der Förderempfehlung");

	/** Die Definition der Tabellenspalte Inhaltl_Prozessbez_Komp */
	public final SchemaTabelleSpalte col_Inhaltl_Prozessbez_Komp = add("Inhaltl_Prozessbez_Komp", SchemaDatentypen.TEXT, false)
			.setJavaComment("Inhalt Prozessbezogene Kompetenzen der Förderempfehlung");

	/** Die Definition der Tabellenspalte Methodische_Komp */
	public final SchemaTabelleSpalte col_Methodische_Komp = add("Methodische_Komp", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleSpalte col_Lern_Arbeitsverhalten = add("Lern_Arbeitsverhalten", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleSpalte col_Massn_Inhaltl_Prozessbez_Komp = add("Massn_Inhaltl_Prozessbez_Komp", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleSpalte col_Massn_Methodische_Komp = add("Massn_Methodische_Komp", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleSpalte col_Massn_Lern_Arbeitsverhalten = add("Massn_Lern_Arbeitsverhalten", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleSpalte col_Verantwortlichkeit_Eltern = add("Verantwortlichkeit_Eltern", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleSpalte col_Verantwortlichkeit_Schueler = add("Verantwortlichkeit_Schueler", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleSpalte col_Zeitrahmen_von_Datum = add("Zeitrahmen_von_Datum", SchemaDatentypen.DATE, false)
			.setConverter(DatumConverter.class)
			.setJavaComment("Zeitrahmen Datum von der Förderempfehlung");

	/** Die Definition der Tabellenspalte Zeitrahmen_bis_Datum */
	public final SchemaTabelleSpalte col_Zeitrahmen_bis_Datum = add("Zeitrahmen_bis_Datum", SchemaDatentypen.DATE, false)
			.setConverter(DatumConverter.class)
			.setJavaComment("Zeitrahmen Datum bis der Förderempfehlung");

	/** Die Definition der Tabellenspalte Ueberpruefung_Datum */
	public final SchemaTabelleSpalte col_Ueberpruefung_Datum = add("Ueberpruefung_Datum", SchemaDatentypen.DATE, false)
			.setConverter(DatumConverter.class)
			.setJavaComment("Datum der Überprüfung der Förderempfehlung");

	/** Die Definition der Tabellenspalte Naechstes_Beratungsgespraech */
	public final SchemaTabelleSpalte col_Naechstes_Beratungsgespraech = add("Naechstes_Beratungsgespraech", SchemaDatentypen.DATE, false)
			.setConverter(DatumConverter.class)
			.setJavaComment("Datum nächstes Beratungsgespräch der Förderempfehlung");

	/** Die Definition der Tabellenspalte EingabeFertig */
	public final SchemaTabelleSpalte col_EingabeFertig = add("EingabeFertig", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_Faecher = add("Faecher", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Fächer der Förderempfehlung im Kürzel komma getrennt");

	/** Die Definition der Tabellenspalte Abgeschlossen */
	public final SchemaTabelleSpalte col_Abgeschlossen = add("Abgeschlossen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerFoerderempfehlungen_Abschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerFoerderempfehlungen_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerFoerderempfehlungen_Lehrer_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerFoerderempfehlungen_Klassen_FK = addForeignKey(

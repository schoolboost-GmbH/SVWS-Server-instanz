...
public class Tabelle_NichtMoeglAbiFachKombi extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_PK = add("PK", SchemaDatentypen.VARCHAR, true).setDatenlaenge(30)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_Phase = add("Phase", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Über welche Jahrgangsstufen geht die Kombination nicht");

	/** Die Definition der Tabellenspalte Typ */
	public final SchemaTabelleSpalte col_Typ = add("Typ", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
	...
	public final SchemaTabelleFremdschluessel fk_NichtMoeglAbiFachKombi_Fach1_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_NichtMoeglAbiFachKombi_Fach2_FK = addForeignKey(

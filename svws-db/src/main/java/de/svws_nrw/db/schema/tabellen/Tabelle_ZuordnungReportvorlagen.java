...
public class Tabelle_ZuordnungReportvorlagen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_AbschlussBB = add("AbschlussBB", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
	...
	public final SchemaTabelleSpalte col_AbschlussArt = add("AbschlussArt", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Reportvorlage = add("Reportvorlage", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleSpalte col_Gruppe = add("Gruppe", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
	...
	public final SchemaTabelleFremdschluessel fk_ZuordnungReportvorlagen_Fachklasse_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_ZuordnungReportvorlagen_Jahrgang_FK = addForeignKey(

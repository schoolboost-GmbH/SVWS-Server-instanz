...
public class Tabelle_EigeneSchule_Teilstandorte extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_AdrMerkmal = add("AdrMerkmal", SchemaDatentypen.VARCHAR, true).setDatenlaenge(1)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_Kuerzel = add("Kuerzel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(30)

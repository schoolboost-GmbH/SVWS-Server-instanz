...
public class Tabelle_Gost_Klausuren_Termine extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Schuljahresabschnitt_ID = add("Schuljahresabschnitt_ID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Klausuren_Termine_Schuljahresabschnitt_ID_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Klausuren_Termine_Abi_Jahrgang_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_Gost_Klausuren_Termine_IDX_Schuljahresabschnitt_ID = addIndex("Gost_Klausuren_Termine_IDX_Schuljahresabschnitt_ID",
			col_Schuljahresabschnitt_ID
	).setRevision(SchemaRevisionen.REV_40);

	/** Die Definition des Non-Unique-Index Gost_Klausuren_Termine_IDX_Abi_Jahrgang */
	public final SchemaTabelleIndex index_Gost_Klausuren_Termine_IDX_Abi_Jahrgang = addIndex("Gost_Klausuren_Termine_IDX_Abi_Jahrgang",
			col_Abi_Jahrgang
	);

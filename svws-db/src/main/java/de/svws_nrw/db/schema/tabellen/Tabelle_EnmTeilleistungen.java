...
public class Tabelle_EnmTeilleistungen extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_EnmTeilleistungen_FK = addForeignKey(
	...
	public final SchemaTabelleTrigger trigger_MariaDB_INSERT_EnmTeilleistungen = addTrigger(
	...
	public final SchemaTabelleTrigger trigger_MariaDB_UPDATE_EnmTeilleistungen = addTrigger(

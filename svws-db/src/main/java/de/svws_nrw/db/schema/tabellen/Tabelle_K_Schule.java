...
public class Tabelle_K_Schule extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Email = add("Email", SchemaDatentypen.VARCHAR, false).setDatenlaenge(40)
			.setJavaComment("E-MailAdresse des Eintrags der Schulen");

	/** Die Definition der Tabellenspalte Schulleiter */
	public final SchemaTabelleSpalte col_Schulleiter = add("Schulleiter", SchemaDatentypen.VARCHAR, false).setDatenlaenge(40)
	...
	public final SchemaTabelleSpalte col_SchulNr_SIM = add("SchulNr_SIM", SchemaDatentypen.VARCHAR, false).setDatenlaenge(6)
	...
	public final SchemaTabelleSpalte col_KurzBez = add("KurzBez", SchemaDatentypen.VARCHAR, false).setDatenlaenge(40)
	...
	public final SchemaTabelleUniqueIndex unique_K_Schule_UC1 = addUniqueIndex("K_Schule_UC1",
			col_SchulNr
	);

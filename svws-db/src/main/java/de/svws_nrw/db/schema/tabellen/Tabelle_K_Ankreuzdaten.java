...
public class Tabelle_K_Ankreuzdaten extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_TextStufe1 = add("TextStufe1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Bezeichnung Stufe 1");

	/** Die Definition der Tabellenspalte TextStufe2 */
	public final SchemaTabelleSpalte col_TextStufe2 = add("TextStufe2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Bezeichnung Stufe 2");

	/** Die Definition der Tabellenspalte TextStufe3 */
	public final SchemaTabelleSpalte col_TextStufe3 = add("TextStufe3", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Bezeichnung Stufe 3");

	/** Die Definition der Tabellenspalte TextStufe4 */
	public final SchemaTabelleSpalte col_TextStufe4 = add("TextStufe4", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Bezeichnung Stufe 4");

	/** Die Definition der Tabellenspalte TextStufe5 */
	public final SchemaTabelleSpalte col_TextStufe5 = add("TextStufe5", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Bezeichnung Stufe 5");

	/** Die Definition der Tabellenspalte BezeichnungSONST */
	public final SchemaTabelleSpalte col_BezeichnungSONST = add("BezeichnungSONST", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)

...
public class Tabelle_LehrerEntlastung extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_LehrerEntlastung_Abschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_LehrerEntlastung_Lehrer_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_LehrerEntlastung_UC1 = addUniqueIndex("LehrerEntlastung_UC1",
			col_Abschnitt_ID,

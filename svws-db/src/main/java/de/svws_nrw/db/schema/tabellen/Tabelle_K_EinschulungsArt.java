...
public class Tabelle_K_EinschulungsArt extends SchemaTabelle {
	...
	public final SchemaTabelleUniqueIndex unique_K_EinschulungsArt_UC1 = addUniqueIndex("K_EinschulungsArt_UC1",
			col_Bezeichnung
	);
	...
	public Tabelle_K_EinschulungsArt() {
		...
		setJavaComment("War urspünglich mal für alle Schulformen verfügbar, ist aber bei den allg.-bildenen Schulen durch die Statkue-Tabelle ersetzt worden."
				+ " Bei WBKs und BKs wird sie aber noch verwendet (der Umstieg auf die Statkue-Tabelle führte da zu Protesten, weil die Schulen keine eigenen"
				+ " Einträge mehr machen konnten).");
	}

...
public class Tabelle_EigeneSchule_Abt_Kl extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Abteilung_ID = add("Abteilung_ID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
	...
	public final SchemaTabelleFremdschluessel fk_EigeneSchule_Abt_Kl_Abteilung_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_EigeneSchule_Abt_Kl_Klassen_FK = addForeignKey(

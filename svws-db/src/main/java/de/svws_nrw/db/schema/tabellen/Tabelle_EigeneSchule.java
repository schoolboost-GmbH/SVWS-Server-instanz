...
public class Tabelle_EigeneSchule extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_SchulformNr = add("SchulformNr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(3)
			.setJavaComment("Schulformnummer der eigenen Schule (Statkue IT.NRW)");

	/** Die Definition der Tabellenspalte SchulformKrz */
	public final SchemaTabelleSpalte col_SchulformKrz = add("SchulformKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(3)
	...
	public final SchemaTabelleSpalte col_SchulformBez = add("SchulformBez", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaComment("Bezeichnender Text der Schulform");

	/** Die Definition der Tabellenspalte SchultraegerArt */
	public final SchemaTabelleSpalte col_SchultraegerArt = add("SchultraegerArt", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setJavaComment("Art des Schulträgers");

	/** Die Definition der Tabellenspalte SchultraegerNr */
	public final SchemaTabelleSpalte col_SchultraegerNr = add("SchultraegerNr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(6)
			.setJavaComment("Schulträgernummer aus dem Katalog der Schulver IT.NRW");

	/** Die Definition der Tabellenspalte SchulNr */
	public final SchemaTabelleSpalte col_SchulNr = add("SchulNr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(6)
	...
	public final SchemaTabelleSpalte col_Bezeichnung1 = add("Bezeichnung1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaComment("1. Text für die Bezeichnung der Schule");

	/** Die Definition der Tabellenspalte Bezeichnung2 */
	public final SchemaTabelleSpalte col_Bezeichnung2 = add("Bezeichnung2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaComment("2. Text für die Bezeichnung der Schule");

	/** Die Definition der Tabellenspalte Bezeichnung3 */
	public final SchemaTabelleSpalte col_Bezeichnung3 = add("Bezeichnung3", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
	...
	public final SchemaTabelleSpalte col_Ort = add("Ort", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
	...
	public final SchemaTabelleSpalte col_Ganztags = add("Ganztags", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_AnzahlAbschnitte = add("AnzahlAbschnitte", SchemaDatentypen.INT, false)
			.setDefault("2")
	...
	public final SchemaTabelleSpalte col_AbschnittBez = add("AbschnittBez", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setDefault("Halbjahr")
			.setJavaComment("Bezeichnung der Abschnitte");

	/** Die Definition der Tabellenspalte BezAbschnitt1 */
	public final SchemaTabelleSpalte col_BezAbschnitt1 = add("BezAbschnitt1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(12)
			.setDefault("1. Hj")
			.setJavaComment("Bezeichnung des ersten Abschnitts");

	/** Die Definition der Tabellenspalte BezAbschnitt2 */
	public final SchemaTabelleSpalte col_BezAbschnitt2 = add("BezAbschnitt2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(12)
			.setDefault("2. Hj")
			.setJavaComment("Bezeichnung des zweiten Abschnitts");

	/** Die Definition der Tabellenspalte BezAbschnitt3 */
	public final SchemaTabelleSpalte col_BezAbschnitt3 = add("BezAbschnitt3", SchemaDatentypen.VARCHAR, false).setDatenlaenge(12)
			.setJavaComment("Bezeichnung des dritten Abschnitts");

	/** Die Definition der Tabellenspalte BezAbschnitt4 */
	public final SchemaTabelleSpalte col_BezAbschnitt4 = add("BezAbschnitt4", SchemaDatentypen.VARCHAR, false).setDatenlaenge(12)
			.setJavaComment("Bezeichnung des vierten Abschnitts");

	/** Die Definition der Tabellenspalte Fremdsprachen */
	public final SchemaTabelleSpalte col_Fremdsprachen = add("Fremdsprachen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
			.setJavaComment("Welche Fremdsprachen werden unterrichtet");

	/** Die Definition der Tabellenspalte JVAZeigen */
	public final SchemaTabelleSpalte col_JVAZeigen = add("JVAZeigen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_RefPaedagogikZeigen = add("RefPaedagogikZeigen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Schule hat Reformpädagogischen-Zweig");

	/** Die Definition der Tabellenspalte AnzJGS_Jahr */
	public final SchemaTabelleSpalte col_AnzJGS_Jahr = add("AnzJGS_Jahr", SchemaDatentypen.SMALLINT, false)
			.setDefault("1")
			.setJavaComment("Anzahl der Jahrgangstufen pro Schuljahr (Semesterbetrieb WBK)");

	/** Die Definition der Tabellenspalte IstHauptsitz */
	public final SchemaTabelleSpalte col_IstHauptsitz = add("IstHauptsitz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_NotenGesperrt = add("NotenGesperrt", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Sperrt die Noteneingabe");

	/** Die Definition der Tabellenspalte ZurueckgestelltAnzahl */
	public final SchemaTabelleSpalte col_ZurueckgestelltAnzahl = add("ZurueckgestelltAnzahl", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_ZurueckgestelltWeibl = add("ZurueckgestelltWeibl", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_ZurueckgestelltAuslaender = add("ZurueckgestelltAuslaender", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_ZurueckgestelltAuslaenderWeibl = add("ZurueckgestelltAuslaenderWeibl", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_ZurueckgestelltAussiedler = add("ZurueckgestelltAussiedler", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_ZurueckgestelltAussiedlerWeibl = add("ZurueckgestelltAussiedlerWeibl", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_TeamTeaching = add("TeamTeaching", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
			.setJavaComment("Aktiviert das Teamteaching");

	/** Die Definition der Tabellenspalte AbiGruppenprozess */
	public final SchemaTabelleSpalte col_AbiGruppenprozess = add("AbiGruppenprozess", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_DauerUnterrichtseinheit = add("DauerUnterrichtseinheit", SchemaDatentypen.INT, false)
			.setJavaComment("Dauer der Unterrichtseinheit (bei NULL = 45 Minuten)");

	/** Die Definition der Tabellenspalte Gruppen8Bis1 */
	public final SchemaTabelleSpalte col_Gruppen8Bis1 = add("Gruppen8Bis1", SchemaDatentypen.INT, false)
			.setJavaComment("Schule hat Betreuung 8 bis 13");

	/** Die Definition der Tabellenspalte Gruppen13Plus */
	public final SchemaTabelleSpalte col_Gruppen13Plus = add("Gruppen13Plus", SchemaDatentypen.INT, false)
			.setJavaComment("Gruppen in der 13Plus-Betreuung");

	/** Die Definition der Tabellenspalte InternatsplaetzeM */
	public final SchemaTabelleSpalte col_InternatsplaetzeM = add("InternatsplaetzeM", SchemaDatentypen.INT, false)
			.setJavaComment("Internatsplätze männlilch");

	/** Die Definition der Tabellenspalte InternatsplaetzeW */
	public final SchemaTabelleSpalte col_InternatsplaetzeW = add("InternatsplaetzeW", SchemaDatentypen.INT, false)
			.setJavaComment("Internatsplätze weiblich");

	/** Die Definition der Tabellenspalte InternatsplaetzeNeutral */
	public final SchemaTabelleSpalte col_InternatsplaetzeNeutral = add("InternatsplaetzeNeutral", SchemaDatentypen.INT, false)
			.setJavaComment("Internatsplätze divers ohne Angabe");

	/** Die Definition der Tabellenspalte SchulLogo */
	public final SchemaTabelleSpalte col_SchulLogo = add("SchulLogo", SchemaDatentypen.LONGBLOB, false)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Schullogo als Bild im Binärformat");

	/** Die Definition der Tabellenspalte SchulLogoBase64 */
	public final SchemaTabelleSpalte col_SchulLogoBase64 = add("SchulLogoBase64", SchemaDatentypen.TEXT, false)
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleSpalte col_SchulleiterName = add("SchulleiterName", SchemaDatentypen.VARCHAR, false).setDatenlaenge(120)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Nachname der Schulleitung");

	/** Die Definition der Tabellenspalte SchulleiterVorname */
	public final SchemaTabelleSpalte col_SchulleiterVorname = add("SchulleiterVorname", SchemaDatentypen.VARCHAR, false).setDatenlaenge(80)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Vorname der Schulleitung");

	/** Die Definition der Tabellenspalte SchulleiterAmtsbez */
	public final SchemaTabelleSpalte col_SchulleiterAmtsbez = add("SchulleiterAmtsbez", SchemaDatentypen.VARCHAR, false).setDatenlaenge(30)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Amtsbezeichnung der Schulleitung");

	/** Die Definition der Tabellenspalte SchulleiterGeschlecht */
	public final SchemaTabelleSpalte col_SchulleiterGeschlecht = add("SchulleiterGeschlecht", SchemaDatentypen.INT, false)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Geschlecht der Schulleitung");

	/** Die Definition der Tabellenspalte StvSchulleiterName */
	public final SchemaTabelleSpalte col_StvSchulleiterName = add("StvSchulleiterName", SchemaDatentypen.VARCHAR, false).setDatenlaenge(120)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Name der stellvertretenden Schulleitung");

	/** Die Definition der Tabellenspalte StvSchulleiterVorname */
	public final SchemaTabelleSpalte col_StvSchulleiterVorname = add("StvSchulleiterVorname", SchemaDatentypen.VARCHAR, false).setDatenlaenge(80)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Vorname der stellvertretenden Schulleitung");

	/** Die Definition der Tabellenspalte StvSchulleiterAmtsbez */
	public final SchemaTabelleSpalte col_StvSchulleiterAmtsbez = add("StvSchulleiterAmtsbez", SchemaDatentypen.VARCHAR, false).setDatenlaenge(30)
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleSpalte col_StvSchulleiterGeschlecht = add("StvSchulleiterGeschlecht", SchemaDatentypen.INT, false)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Geschlecht der stellvertretenden Schulleitung");

	/** Die Definition der Tabellenspalte Einstellungen */
	public final SchemaTabelleSpalte col_Einstellungen = add("Einstellungen", SchemaDatentypen.TEXT, false)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment(
	...
	public final SchemaTabelleSpalte col_WebAdresse = add("WebAdresse", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Enthält die Homepage-Adresse URL der Schule");

	/** Die Definition der Tabellenspalte Land */
	public final SchemaTabelleSpalte col_Land = add("Land", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
	...
	public final SchemaTabelleSpalte col_SchuljahrAbschnitt = add("SchuljahrAbschnitt", SchemaDatentypen.INT, false)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Aktueller Abschnitt der Datenbank");


	/** Die Definition des Fremdschlüssels EigeneSchule_Schuljahreabschnitt_FK */
	public final SchemaTabelleFremdschluessel fk_EigeneSchule_Schuljahreabschnitt_FK = addForeignKey(

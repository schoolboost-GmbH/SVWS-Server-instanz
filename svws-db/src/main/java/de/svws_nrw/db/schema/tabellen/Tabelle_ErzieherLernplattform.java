...
public class Tabelle_ErzieherLernplattform extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_ErzieherID = add("ErzieherID", SchemaDatentypen.BIGINT, true)
			.setNotNull()
	...
	public final SchemaTabelleFremdschluessel fk_ErzieherLernplattform_Erzieher_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_ErzieherLernplattform_Lernplattform_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_ErzieherLernplattform_Credential_FK = addForeignKey(

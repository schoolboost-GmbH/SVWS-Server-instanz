 ...
 */
public class Tabelle_UV_Stundentafeln_Faecher_Deprecated_Revision_49 extends SchemaTabelle {
	 ...
	 */
	public Tabelle_UV_Stundentafeln_Faecher_Deprecated_Revision_49() {
		super("UV_Stundentafeln_Faecher", SchemaRevisionen.REV_48);
		setMigrate(false);
		setImportExport(true);
		setJavaSubPackage("uv");
		setJavaClassName("DTOUvStundentafelFach_Deprecated_Revision_49");

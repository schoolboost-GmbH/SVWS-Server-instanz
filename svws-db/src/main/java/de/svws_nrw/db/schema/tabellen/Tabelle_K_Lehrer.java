...
public class Tabelle_K_Lehrer extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_LIDKrz = add("LIDKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(4)
			.setJavaName("kuerzelLID")
			.setJavaComment("Lehrer-Kürzel für eine eindeutige Identifikation des Lehrers – Verwendung für die Statistik - TODO lassen sich kuerzel und LIDKrz"
					+ " nicht sinnvoll zusammenfassen?");
	...
	public final SchemaTabelleSpalte col_PersonTyp = add("PersonTyp", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setDefault("LEHRKRAFT")
			.setConverter(PersonalTypConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Die Art der Person – wurde nachträglich hinzugefügt, damit auch Nicht-Lehrer in die Liste aufgenommen und unterschieden"
					+ " werden können");
	...
	public final SchemaTabelleSpalte col_FuerExport = add("FuerExport", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
			.setJavaComment("Gibt an, ob der Lehrer-Datensatz für den Export in andere Software verwendet werden soll - TODO fuer welche(n) Zweck(e) wird"
					+ " dies gespeichert - gehört dies an diese Stelle? ");

	/** Die Definition der Tabellenspalte Statistik */
	public final SchemaTabelleSpalte col_Statistik = add("Statistik", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_PLZ = add("PLZ", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			...
			.setJavaComment("DEPRECATED: Adressdaten des Lehrers: Postleitzahl - Ort als Spalte in der Tabelle ergänzen, ähnlich wie bei Schüler, wichtig da"
					+ " ansonsten Probleme auftauchen, wenn ein PLZ ? Ortsname nicht eindeutig ist, was gelegentlich vorkommt");
	...
	public final SchemaTabelleSpalte col_Tel = add("Tel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaName("telefon")
			.setJavaComment("Adressdaten des Lehrers: Telefonnummer");

	/** Die Definition der Tabellenspalte Handy */
	public final SchemaTabelleSpalte col_Handy = add("Handy", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
	...
	public final SchemaTabelleSpalte col_EmailDienstlich = add("EmailDienstlich", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
	...
	public final SchemaTabelleSpalte col_Geschlecht = add("Geschlecht", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setConverter(GeschlechtConverterFromString.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Das Geschlecht des Lehrers - TODO ist in der Datenbank als String und nicht als Integer (3/4) hinterlegt, dies sollte in allen"
					+ " Tabellen einheitlich sein");

	/** Die Definition der Tabellenspalte Anrede */
	public final SchemaTabelleSpalte col_Anrede = add("Anrede", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Die Anrede für den Lehrer");

	/** Die Definition der Tabellenspalte Amtsbezeichnung */
	public final SchemaTabelleSpalte col_Amtsbezeichnung = add("Amtsbezeichnung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(15)
			.setJavaComment("Die Amtsbezeichnung des Lehrers");

	/** Die Definition der Tabellenspalte Titel */
	public final SchemaTabelleSpalte col_Titel = add("Titel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("Ggf. der Titel des Lehrers");

	/** Die Definition der Tabellenspalte Faecher */
	public final SchemaTabelleSpalte col_Faecher = add("Faecher", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Die Fächer, die der Lehrer unterrichtet - TODO hat dieses Feld noch einen Zweck? Fächer sind dem Lehrer eigentlich anders"
					+ " zugeordnet...  ");

	/** Die Definition der Tabellenspalte IdentNr1 */
	public final SchemaTabelleSpalte col_IdentNr1 = add("IdentNr1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaName("identNrTeil1")
			.setJavaComment("Der vordere Teil der NRW-weit eindeutigen Ident-Nummer - setzt sich normalerweise aus Geburtsdatum und Geschlecht (3/4) zusammen,"
					+ " kann in Einzelfällen aber von diesem Schema abweichen");

	/** Die Definition der Tabellenspalte SerNr */
	public final SchemaTabelleSpalte col_SerNr = add("SerNr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(5)
	...
	public final SchemaTabelleSpalte col_PANr = add("PANr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("Personalakten-Nummer (wird von den Bezirksregierungen ggf genutzt)");

	/** Die Definition der Tabellenspalte LBVNr */
	public final SchemaTabelleSpalte col_LBVNr = add("LBVNr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(15)
	...
	public final SchemaTabelleSpalte col_VSchluessel = add("VSchluessel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setJavaName("verguetungsSchluessel")
			.setJavaComment("Der Vergütungsschlüssel");

	/** Die Definition der Tabellenspalte DatumZugang */
	public final SchemaTabelleSpalte col_DatumZugang = add("DatumZugang", SchemaDatentypen.DATE, false)
			.setConverter(DatumConverter.class)
			.setJavaComment("Das Datum, wann der Lehrer an die Schule gekommen ist.");

	/** Die Definition der Tabellenspalte GrundZugang */
	public final SchemaTabelleSpalte col_GrundZugang = add("GrundZugang", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Der Grund für den Zugang des Lehrers");

	/** Die Definition der Tabellenspalte DatumAbgang */
	public final SchemaTabelleSpalte col_DatumAbgang = add("DatumAbgang", SchemaDatentypen.DATE, false)
			.setConverter(DatumConverter.class)
			.setJavaComment("Das Datum, wann der Lehrer die Schule verlassen hat.");

	/** Die Definition der Tabellenspalte GrundAbgang */
	public final SchemaTabelleSpalte col_GrundAbgang = add("GrundAbgang", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Der Grund für das Verlassen der Schule durch den Lehrer");

	/** Die Definition der Tabellenspalte KennwortTools */
	public final SchemaTabelleSpalte col_KennwortTools = add("KennwortTools", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleSpalte col_KennwortToolsAktuell = add("KennwortToolsAktuell", SchemaDatentypen.VARCHAR, false).setDatenlaenge(3)
			.setVeraltet(SchemaRevisionen.REV_18)
			.setDefault("-;5")
	...
	public final SchemaTabelleSpalte col_LPassword = add("LPassword", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleSpalte col_PWAktuell = add("PWAktuell", SchemaDatentypen.VARCHAR, false).setDatenlaenge(3)
			.setDefault("-;5")
	...
	public final SchemaTabelleSpalte col_Rechtsverhaeltnis = add("Rechtsverhaeltnis", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
	...
	public final SchemaTabelleSpalte col_Beschaeftigungsart = add("Beschaeftigungsart", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setJavaComment("Die Art der Beschäftigung (Vollzeit, Teilzeit, etc.)")
			.setVeraltet(SchemaRevisionen.REV_2);

	/** [ASD] Die Definition der Tabellenspalte Einsatzstatus */
	public final SchemaTabelleSpalte col_Einsatzstatus = add("Einsatzstatus", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setJavaComment("[ASD] Der Einsatzstatus (z.B. Stammschule, nur hier tätig)")
			.setVeraltet(SchemaRevisionen.REV_2);

	/** Die Definition der Tabellenspalte StammschulNr */
	public final SchemaTabelleSpalte col_StammschulNr = add("StammschulNr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(6)
			.setJavaComment("Die Schulnummer der Stammschule, sofern diese abweicht")
			.setVeraltet(SchemaRevisionen.REV_2);

	/** Die Definition der Tabellenspalte UnterrichtsStd */
	public final SchemaTabelleSpalte col_UnterrichtsStd = add("UnterrichtsStd", SchemaDatentypen.FLOAT, false)
	...
	public final SchemaTabelleSpalte col_RestStd = add("RestStd", SchemaDatentypen.FLOAT, false)
			.setJavaComment("Berechnetes Feld: Reststunden")
			.setVeraltet(SchemaRevisionen.REV_2);

	/** Die Definition der Tabellenspalte SchILDweb_FL */
	public final SchemaTabelleSpalte col_SchILDweb_FL = add("SchILDweb_FL", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_SchILDweb_KL = add("SchILDweb_KL", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
			.setJavaComment("DEPRECATED: nicht mehr genutzt SchildWeb")
			.setVeraltet(SchemaRevisionen.REV_2);
	...
	public final SchemaTabelleSpalte col_SchILDweb_Config = add("SchILDweb_Config", SchemaDatentypen.TEXT, false)
			.setJavaComment("DEPRECATED: nicht mehr genutzt SchildWeb")
			.setVeraltet(SchemaRevisionen.REV_2);

	/** Die Definition der Tabellenspalte Antwort1 */
	public final SchemaTabelleSpalte col_Antwort1 = add("Antwort1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("DEPRECATED: wurde nie verwendet")
			.setVeraltet(SchemaRevisionen.REV_2);

	/** Die Definition der Tabellenspalte Antwort2 */
	public final SchemaTabelleSpalte col_Antwort2 = add("Antwort2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("DEPRECATED: wurde nie verwendet")
			.setVeraltet(SchemaRevisionen.REV_2);

	/** Die Definition der Tabellenspalte XNMPassword */
	public final SchemaTabelleSpalte col_XNMPassword = add("XNMPassword", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Passwort für das XNM-Tool ")
			.setVeraltet(SchemaRevisionen.REV_2);

	/** Die Definition der Tabellenspalte XNMPassword2 */
	public final SchemaTabelleSpalte col_XNMPassword2 = add("XNMPassword2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleFremdschluessel fk_K_Lehrer_Credentials_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_K_Lehrer_Ort_FK = addForeignKey(
			"K_Lehrer_Ort_FK",
			/* OnUpdate: */ SchemaFremdschluesselAktionen.CASCADE,
			/* OnDelete: */ SchemaFremdschluesselAktionen.SET_NULL,
	...
	public final SchemaTabelleFremdschluessel fk_K_Lehrer_Ortsteil_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_K_Lehrer_PersonTyp_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_K_Lehrer_Statkue_Nationalitaeten_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_K_Lehrer_UC1 = addUniqueIndex("K_Lehrer_UC1",
			col_Kuerzel
	);

...
public class Tabelle_EigeneSchule_Faecher extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_ZeugnisBez = add("ZeugnisBez", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleSpalte col_UeZeugnisBez = add("UeZeugnisBez", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleSpalte col_Zeugnisdatenquelle_ID = add("Zeugnisdatenquelle_ID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_Fachgruppe_ID = add("Fachgruppe_ID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_StatistikKrz = add("StatistikKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_BasisFach = add("BasisFach", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_IstSprache = add("IstSprache", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_SortierungS2 = add("SortierungS2", SchemaDatentypen.INT, false)
			.setDefault("32000")
	...
	public final SchemaTabelleSpalte col_NachprErlaubt = add("NachprErlaubt", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_Gewichtung = add("Gewichtung", SchemaDatentypen.SMALLINT, false)
			.setDefault("1")
			.setJavaComment(
	...
	public final SchemaTabelleSpalte col_Unterichtssprache = add("Unterichtssprache", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("D")
	...
	public final SchemaTabelleSpalte col_IstSchriftlich = add("IstSchriftlich", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_IstSchriftlichBA = add("IstSchriftlichBA", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
	...
	public final SchemaTabelleSpalte col_IstPruefungsordnungsRelevant = add("IstPruefungsordnungsRelevant", SchemaDatentypen.SMALLINT, false)
			.setNotNull()
			.setDefault("1")
	...
	public final SchemaTabelleSpalte col_LK_Moegl = add("LK_Moegl", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_Abi_Moegl = add("Abi_Moegl", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_E1 = add("E1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_E2 = add("E2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_Q1 = add("Q1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_Q2 = add("Q2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_Q3 = add("Q3", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_Q4 = add("Q4", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_AlsNeueFSInSII = add("AlsNeueFSInSII", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_E2_WZE = add("E2_WZE", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Q_WZE = add("Q_WZE", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_E1_S = add("E1_S", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_E2_S = add("E2_S", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_NurMuendlich = add("NurMuendlich", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_Aufgabenfeld = add("Aufgabenfeld", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setJavaComment("Das Aufgabenfeld, zu welchem das Fach gehört");

	/** Die Definition der Tabellenspalte AbgeschlFaecherHolen */
	public final SchemaTabelleSpalte col_AbgeschlFaecherHolen = add("AbgeschlFaecherHolen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_GewichtungFHR = add("GewichtungFHR", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_MaxBemZeichen = add("MaxBemZeichen", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleFremdschluessel fk_EigeneSchule_Faecher_Zeugnisdatenquellen_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_EigeneSchule_Faecher_UC1 = addUniqueIndex("EigeneSchule_Faecher_UC1",
			col_FachKrz);

...
public class Tabelle_Fach_Gliederungen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Gliederung = add("Gliederung", SchemaDatentypen.VARCHAR, true).setDatenlaenge(3)
			.setNotNull()
			.setJavaComment("SGL für die gliederungsbezogenen Einstellungen zum Fach (BK)");

	/** Die Definition der Tabellenspalte Fachklasse_ID */
	public final SchemaTabelleSpalte col_Fachklasse_ID = add("Fachklasse_ID", SchemaDatentypen.BIGINT, true)
			.setDefault("0")
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_Faechergruppe = add("Faechergruppe", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_GewichtungAB = add("GewichtungAB", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_GewichtungBB = add("GewichtungBB", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_SchriftlichAB = add("SchriftlichAB", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_SchriftlichBB = add("SchriftlichBB", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
	...
	public final SchemaTabelleSpalte col_GymOSFach = add("GymOSFach", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)

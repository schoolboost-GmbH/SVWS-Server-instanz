...
public class Tabelle_Gost_Blockung_Kurse extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_IstKoopKurs = add("IstKoopKurs", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_BezeichnungSuffix = add("BezeichnungSuffix", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment(
	...
	public final SchemaTabelleSpalte col_Schienenanzahl = add("Schienenanzahl", SchemaDatentypen.INT, false)
			.setDefault("1")
			.setNotNull()
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Blockung_Kurse_Blockung_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Blockung_Kurse_Fach_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_Gost_Blockung_Kurse_IDX_Blockung_ID = addIndex("Gost_Blockung_Kurse_IDX_Blockung_ID",
			col_Blockung_ID
	);

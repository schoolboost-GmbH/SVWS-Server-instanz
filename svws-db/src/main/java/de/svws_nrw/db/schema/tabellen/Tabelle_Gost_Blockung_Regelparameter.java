...
public class Tabelle_Gost_Blockung_Regelparameter extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Blockung_Regelparameter_Regel_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_Gost_Blockung_Regelparameter_IDX_Regel_ID = addIndex("Gost_Blockung_Regelparameter_IDX_Regel_ID",
			col_Regel_ID
	);

	/** Die Definition des Non-Unique-Index Gost_Blockung_Regelparameter_IDX_Regel_ID_Nummer */
	public final SchemaTabelleIndex index_Gost_Blockung_Regelparameter_IDX_Regel_ID_Nummer = addIndex("Gost_Blockung_Regelparameter_IDX_Regel_ID_Nummer",
			col_Regel_ID,
			col_Nummer
	);

	/** Die Definition des Non-Unique-Index Gost_Blockung_Regelparameter_IDX_Regel_ID_Nummer_Parameter */
	public final SchemaTabelleIndex index_Gost_Blockung_Regelparameter_IDX_Regel_ID_Nummer_Parameter =

...
public class Tabelle_Kurse extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_KurzBez = add("KurzBez", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_WochenStd = add("WochenStd", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_LehrerKrz = add("LehrerKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(22)
	...
	public final SchemaTabelleSpalte col_Schienen = add("Schienen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("Auflistung der Schienen in denen der Kurs ist");

	/** Die Definition der Tabellenspalte Fortschreibungsart */
	public final SchemaTabelleSpalte col_Fortschreibungsart = add("Fortschreibungsart", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
	...
	public final SchemaTabelleSpalte col_WochenstdKL = add("WochenstdKL", SchemaDatentypen.FLOAT, false)
	...
	public final SchemaTabelleSpalte col_EpochU = add("EpochU", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_ZeugnisBez = add("ZeugnisBez", SchemaDatentypen.VARCHAR, false).setDatenlaenge(130)
			.setJavaComment("Zeugnisbezeichnung des Kurses");

	/** Die Definition der Tabellenspalte Jahrgaenge */
	public final SchemaTabelleSpalte col_Jahrgaenge = add("Jahrgaenge", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
	...
	public final SchemaTabelleFremdschluessel fk_Kurse_Schuljahreabschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Kurse_Jahrgang_FK = addForeignKey(
			"Kurse_Jahrgang_FK",
			/* OnUpdate: */ SchemaFremdschluesselAktionen.CASCADE,
	...
	public final SchemaTabelleFremdschluessel fk_Kurse_Fach_FK = addForeignKey(
			"Kurse_Fach_FK",
			/* OnUpdate: */ SchemaFremdschluesselAktionen.CASCADE,
	...
	public final SchemaTabelleFremdschluessel fk_Kurse_Lehrer_FK = addForeignKey(
			"Kurse_Lehrer_FK",
			/* OnUpdate: */ SchemaFremdschluesselAktionen.CASCADE,
			/* OnDelete: */ SchemaFremdschluesselAktionen.SET_NULL,
	...
	public final SchemaTabelleFremdschluessel fk_Kurse_Fortschreibungsart_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_Kurse_IDX_Schuljahresabschnitts_ID = addIndex("Kurse_IDX_Schuljahresabschnitts_ID",
			col_Schuljahresabschnitts_ID
	);

	/** Die Definition des Non-Unique-Index Kurse_IDX_Fach_ID */
	public final SchemaTabelleIndex index_Kurse_IDX_Fach_ID = addIndex("Kurse_IDX_Fach_ID",
			col_Fach_ID
	);

	/** Die Definition des Non-Unique-Index Kurse_IDX_Jahrgang_ID */
	public final SchemaTabelleIndex index_Kurse_IDX_Jahrgang_ID = addIndex("Kurse_IDX_Jahrgang_ID",
			col_Jahrgang_ID
	);

	/** Die Definition des Non-Unique-Index Kurse_IDX_Lehrer_ID */
	public final SchemaTabelleIndex index_Kurse_IDX_Lehrer_ID = addIndex("Kurse_IDX_Lehrer_ID",
			col_Lehrer_ID
	);

	/** Die Definition des Unique-Index Kurse_UC1 */
	public final SchemaTabelleUniqueIndex unique_Kurse_UC1 = addUniqueIndex("Kurse_UC1",
			col_Jahrgaenge,
			col_Schuljahresabschnitts_ID,
			col_Fach_ID,
			col_ASDJahrgang,

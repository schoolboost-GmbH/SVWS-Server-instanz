...
public class Tabelle_SchuelerAnkreuzfloskeln extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Floskel_ID = add("Floskel_ID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
			.setJavaComment("ID der Ankreuzfloskel aus dem Katalog");

	/** Die Definition der Tabellenspalte Stufe1 */
	public final SchemaTabelleSpalte col_Stufe1 = add("Stufe1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_Stufe2 = add("Stufe2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Gibt an ob diese Stufe angekreuzt ist");

	/** Die Definition der Tabellenspalte Stufe3 */
	public final SchemaTabelleSpalte col_Stufe3 = add("Stufe3", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Gibt an ob diese Stufe angekreuzt ist");

	/** Die Definition der Tabellenspalte Stufe4 */
	public final SchemaTabelleSpalte col_Stufe4 = add("Stufe4", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Gibt an ob diese Stufe angekreuzt ist");

	/** Die Definition der Tabellenspalte Stufe5 */
	public final SchemaTabelleSpalte col_Stufe5 = add("Stufe5", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Gibt an ob diese Stufe angekreuzt ist");
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerAnkreuzfloskeln_Abschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerAnkreuzfloskeln_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerAnkreuzfloskeln_Floskel_FK = addForeignKey(

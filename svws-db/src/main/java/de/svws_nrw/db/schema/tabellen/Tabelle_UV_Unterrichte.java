...
public class Tabelle_UV_Unterrichte extends SchemaTabelle {
    ...
    public SchemaTabelleSpalte col_ZeitrasterEintrag_ID = add("ZeitrasterEintrag_ID", SchemaDatentypen.BIGINT, false)
...
//            .setJavaComment("Fremdschlüssel auf den Raum (Tabelle UV_Raeume)");
    ...
    public SchemaTabelleFremdschluessel fk_UVUnterrichte_UVZeitrasterEintraege_FK = addForeignKey(
    ...
    public SchemaTabelleFremdschluessel fk_UVUnterrichte_UVLerngruppen_FK = addForeignKey(
...
//    public SchemaTabelleFremdschluessel fk_UV_Raeume_FK = addForeignKey(
//            "UV_Raeume_FK",
//            /* OnUpdate: */ SchemaFremdschluesselAktionen.CASCADE,
//            /* OnDelete: */ SchemaFremdschluesselAktionen.SET_NULL,
...
//    );
	...
	public SchemaTabelleUniqueIndex unique_UV_Unterrichte_UC1 = addUniqueIndex("UV_Unterrichte_UC1",
			col_ID,

...
public class Tabelle_Stundenplan_Raeume extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_Stundenplan_Raeume_Stundenplan_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_Stundenplan_Raeume_UC1 = addUniqueIndex("Stundenplan_Raeume_UC1",
			col_Stundenplan_ID,
			col_Kuerzel
	);
	...
	public Tabelle_Stundenplan_Raeume() {
		...
		setJavaComment("Enthält die Liste von Räumen, welche im Stundenplan verwendet werden. Dieser wird üblicherweise aus der Tabelle Katalog_Raeume"
				+ " übernommen und hier zwischengespeichert. Änderungen im Katalog werden nicht hierhin übernommen.");
	}

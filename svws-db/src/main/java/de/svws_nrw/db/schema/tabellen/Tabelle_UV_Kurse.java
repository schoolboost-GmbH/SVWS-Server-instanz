...
public class Tabelle_UV_Kurse extends SchemaTabelle {
    ...
    public SchemaTabelleFremdschluessel fk_UVKurse_Schuljahresabschnitte_FK = addForeignKey(
    ...
    public SchemaTabelleFremdschluessel fk_UVKurse_UVFaecher_FK = addForeignKey(
    ...
    public SchemaTabelleFremdschluessel fk_UVKurse_UVSchuelergruppen_FK = addForeignKey(
	...
	public SchemaTabelleUniqueIndex unique_UVKurse_UC1 = addUniqueIndex("UVKurse_UC1",

...
public class Tabelle_SchuelerTelefone extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_TelefonArt_ID = add("TelefonArt_ID", SchemaDatentypen.BIGINT, false)
			.setJavaComment("Art des Telefonnummerneintrags");

	/** Die Definition der Tabellenspalte Telefonnummer */
	public final SchemaTabelleSpalte col_Telefonnummer = add("Telefonnummer", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("Telefonnummer des Telefonnummerneintrags");

	/** Die Definition der Tabellenspalte Bemerkung */
	public final SchemaTabelleSpalte col_Bemerkung = add("Bemerkung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerTelefone_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerTelefone_Telefonart_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_SchuelerTelefone_IDX1 = addIndex("SchuelerTelefone_IDX1",
			col_Schueler_ID
	);

...
public class Tabelle_Noten extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Kuerzel = add("Kuerzel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setNotNull()
			.setJavaComment("Das Kürzel der Note");

	/** Die Definition der Tabellenspalte IstTendenznote */
	public final SchemaTabelleSpalte col_IstTendenznote = add("IstTendenznote", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_Text = add("Text", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Die Bezeichnung der Note");

	/** Die Definition der Tabellenspalte AufZeugnis */
	public final SchemaTabelleSpalte col_AufZeugnis = add("AufZeugnis", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
			.setConverter(Boolean01Converter.class)
	...
	public final SchemaTabelleSpalte col_Notenpunkte = add("Notenpunkte", SchemaDatentypen.INT, false)
			.setJavaComment("Die Notenpunkte der Note in der Sekundarstufe II");

	/** Die Definition der Tabellenspalte TextLaufbahnSII */
	public final SchemaTabelleSpalte col_TextLaufbahnSII = add("TextLaufbahnSII", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_AufLaufbahnSII = add("AufLaufbahnSII", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
			.setConverter(Boolean01Converter.class)
	...
	public final SchemaTabelleUniqueIndex unique_Noten_UC1 = addUniqueIndex("Noten_UC1",
			col_Kuerzel
	);

...
public class Tabelle_SchuelerAbiFaecher extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_FachKrz = add("FachKrz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaName("FachKuerzel")
			.setJavaComment("Das Kürzel des Faches");

	/** Die Definition der Tabellenspalte FSortierung */
	public final SchemaTabelleSpalte col_FSortierung = add("FSortierung", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Fachlehrer_ID = add("Fachlehrer_ID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_AbiFach = add("AbiFach", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
	...
	public final SchemaTabelleSpalte col_P11_1 = add("P11_1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_S11_1 = add("S11_1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_P11_2 = add("P11_2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_S11_2 = add("S11_2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_P_FA = add("P_FA", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_R_FA = add("R_FA", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("Facharbeit_MarkiertFuerAbiturBerechnung")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("BK: eingebrachte Facharbeit – Gibt an, ob die Notenpunkte bei der Abiturberechnung genutzt werden, d.h. zur Nutzung markiert"
					+ " wurden. (+: Nutze für Berechnung, -: Nutze nicht für die Berechnung; /: Für die Nutzung zur Berechnung gesperrt)");

	/** Die Definition der Tabellenspalte W12_1 */
	public final SchemaTabelleSpalte col_W12_1 = add("W12_1", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_P12_1 = add("P12_1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_H12_1 = add("H12_1", SchemaDatentypen.INT, false)
			.setJavaName("-")
	...
	public final SchemaTabelleSpalte col_R12_1 = add("R12_1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("Q1_HJ1_MarkiertFuerAbiturBerechnung")
			.setConverter(AbiturKursMarkierungConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Q1, 1. Hj: Gibt an, ob die Notenpunkte bei der Abiturberechnung genutzt werden, d.h. zur Nutzung markiert wurden."
					+ " (+: Nutze für Berechnung, -: Nutze nicht für die Berechnung; /: Für die Nutzung zur Berechnung gesperrt)");

	/** Die Definition der Tabellenspalte S12_1 */
	public final SchemaTabelleSpalte col_S12_1 = add("S12_1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("Q1_HJ1_BelegungArt")
			.setConverter(AbiturBelegungsartConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Q1, 1. Hj: Gibt die Art und Schriftlichkeit des Kurses an"
					+ " (-: nicht belegt, M: GK mündlich, S: GK schriftlich, Z: Zusatzkurs, L: LK)");

	/** Die Definition der Tabellenspalte W12_2 */
	public final SchemaTabelleSpalte col_W12_2 = add("W12_2", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_P12_2 = add("P12_2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_H12_2 = add("H12_2", SchemaDatentypen.INT, false)
			.setJavaName("-")
	...
	public final SchemaTabelleSpalte col_R12_2 = add("R12_2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("Q1_HJ2_MarkiertFuerAbiturBerechnung")
			.setConverter(AbiturKursMarkierungConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Q1, 2. Hj: Gibt an, ob die Notenpunkte bei der Abiturberechnung genutzt werden, d.h. zur Nutzung markiert wurden."
					+ " (+: Nutze für Berechnung, -: Nutze nicht für die Berechnung; /: Für die Nutzung zur Berechnung gesperrt)");

	/** Die Definition der Tabellenspalte S12_2 */
	public final SchemaTabelleSpalte col_S12_2 = add("S12_2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("Q1_HJ2_BelegungArt")
			.setConverter(AbiturBelegungsartConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Q1, 2. Hj: Gibt die Art und Schriftlichkeit des Kurses an"
					+ " (-: nicht belegt, M: GK mündlich, S: GK schriftlich, Z: Zusatzkurs, L: LK)");

	/** Die Definition der Tabellenspalte W13_1 */
	public final SchemaTabelleSpalte col_W13_1 = add("W13_1", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_P13_1 = add("P13_1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_H13_1 = add("H13_1", SchemaDatentypen.INT, false)
			.setJavaName("-")
	...
	public final SchemaTabelleSpalte col_R13_1 = add("R13_1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("Q2_HJ1_MarkiertFuerAbiturBerechnung")
			.setConverter(AbiturKursMarkierungConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Q2, 1. Hj: Gibt an, ob die Notenpunkte bei der Abiturberechnung genutzt werden, d.h. zur Nutzung markiert wurden."
					+ " (+: Nutze für Berechnung, -: Nutze nicht für die Berechnung; /: Für die Nutzung zur Berechnung gesperrt)");

	/** Die Definition der Tabellenspalte S13_1 */
	public final SchemaTabelleSpalte col_S13_1 = add("S13_1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("Q2_HJ1_BelegungArt")
			.setConverter(AbiturBelegungsartConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Q2, 1. Hj: Gibt die Art und Schriftlichkeit des Kurses an"
					+ " (-: nicht belegt, M: GK mündlich, S: GK schriftlich, Z: Zusatzkurs, L: LK)");

	/** Die Definition der Tabellenspalte W13_2 */
	public final SchemaTabelleSpalte col_W13_2 = add("W13_2", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_P13_2 = add("P13_2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_H13_2 = add("H13_2", SchemaDatentypen.INT, false)
			.setJavaName("-")
	...
	public final SchemaTabelleSpalte col_R13_2 = add("R13_2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("Q2_HJ2_MarkiertFuerAbiturBerechnung")
			.setConverter(AbiturKursMarkierungConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Q2, 2. Hj: Gibt an, ob die Notenpunkte bei der Abiturberechnung genutzt werden, d.h. zur Nutzung markiert wurden."
					+ " (+: Nutze für Berechnung, -: Nutze nicht für die Berechnung; /: Für die Nutzung zur Berechnung gesperrt)");

	/** Die Definition der Tabellenspalte S13_2 */
	public final SchemaTabelleSpalte col_S13_2 = add("S13_2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("Q2_HJ2_BelegungArt")
			.setConverter(AbiturBelegungsartConverter.class)
			.setConverterRevision(SchemaRevisionen.REV_1)
			.setJavaComment("Q2, 2. Hj: Gibt die Art und Schriftlichkeit des Kurses an"
					+ " (-: nicht belegt, M: GK mündlich, S: GK schriftlich, Z: Zusatzkurs, L: LK)");

	/** Die Definition der Tabellenspalte Zulassung */
	public final SchemaTabelleSpalte col_Zulassung = add("Zulassung", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_Durchschnitt = add("Durchschnitt", SchemaDatentypen.FLOAT, false)
	...
	public final SchemaTabelleSpalte col_AbiPruefErgebnis = add("AbiPruefErgebnis", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_Zwischenstand = add("Zwischenstand", SchemaDatentypen.SMALLINT, false)
			.setJavaName("PruefungPunktsummeZwischenstand")
			.setJavaComment("Die Notenpunkte aus der Abiturprüfung multipliziert mit dem entsprechenden Faktor, falls das Fach eines der vier Abiturfächer ist"
					+ " (hier wird z.B. die besondere Lernleistung berücksichtigt");

	/** Die Definition der Tabellenspalte MdlPflichtPruefung */
	public final SchemaTabelleSpalte col_MdlPflichtPruefung = add("MdlPflichtPruefung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_MdlBestPruefung = add("MdlBestPruefung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("PruefungMuendlichBestehen")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("true, falls eine mündliche Bestehensprüfung in den ersten drei Abiturfächern notwendig ist, damit das Abitur noch bestanden"
					+ " werden kann.");

	/** Die Definition der Tabellenspalte MdlFreiwPruefung */
	public final SchemaTabelleSpalte col_MdlFreiwPruefung = add("MdlFreiwPruefung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_MdlPruefErgebnis = add("MdlPruefErgebnis", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_MdlPruefFolge = add("MdlPruefFolge", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_AbiErgebnis = add("AbiErgebnis", SchemaDatentypen.SMALLINT, false)
			.setJavaName("PruefungPunktsummeGesamt")
			.setJavaComment("Die Notenpunkte aus der Abiturprüfung multipliziert mit dem entsprechenden Faktor (hier wird z.B. die besondere Lernleistung) und"
					+ " unter Einbeziehung einer möglichen mündlicher Prüfung");
	...
	public final SchemaTabelleSpalte col_Fachlehrer = add("Fachlehrer", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerAbiFaecher_Fach_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerAbiFaecher_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerAbiFaecher_Kurs_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_SchuelerAbiFaecher_IDX_Schueler_ID = addIndex("SchuelerAbiFaecher_IDX_Schueler_ID",
			col_Schueler_ID

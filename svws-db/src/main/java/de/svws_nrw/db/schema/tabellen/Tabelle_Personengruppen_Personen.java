...
public class Tabelle_Personengruppen_Personen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Gruppe_ID = add("Gruppe_ID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
			.setJavaComment("GruppenID des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte Person_ID */
	public final SchemaTabelleSpalte col_Person_ID = add("Person_ID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_PersonNr = add("PersonNr", SchemaDatentypen.INT, false)
			.setJavaComment("Personennummer des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonArt */
	public final SchemaTabelleSpalte col_PersonArt = add("PersonArt", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setJavaComment("PersonenArt des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonName */
	public final SchemaTabelleSpalte col_PersonName = add("PersonName", SchemaDatentypen.VARCHAR, false).setDatenlaenge(120)
			.setNotNull()
			.setJavaComment("Name des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonVorname */
	public final SchemaTabelleSpalte col_PersonVorname = add("PersonVorname", SchemaDatentypen.VARCHAR, false).setDatenlaenge(80)
			.setJavaComment("Vorname des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonPLZ */
	public final SchemaTabelleSpalte col_PersonPLZ = add("PersonPLZ", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("PLZ des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonOrt */
	public final SchemaTabelleSpalte col_PersonOrt = add("PersonOrt", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaComment("Ort des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonStrasse */
	public final SchemaTabelleSpalte col_PersonStrasse = add("PersonStrasse", SchemaDatentypen.VARCHAR, false).setDatenlaenge(55)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("Straße des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonStrassenname */
	public final SchemaTabelleSpalte col_PersonStrassenname = add("PersonStrassenname", SchemaDatentypen.VARCHAR, false).setDatenlaenge(55)
			.setJavaComment("Straßenname zur Person der Personengruppe");

	/** Die Definition der Tabellenspalte PersonHausNr */
	public final SchemaTabelleSpalte col_PersonHausNr = add("PersonHausNr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Hausnummer wenn getrennt gespeichert");

	/** Die Definition der Tabellenspalte PersonHausNrZusatz */
	public final SchemaTabelleSpalte col_PersonHausNrZusatz = add("PersonHausNrZusatz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(30)
	...
	public final SchemaTabelleSpalte col_PersonTelefon = add("PersonTelefon", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("Telfonnummer des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonMobil */
	public final SchemaTabelleSpalte col_PersonMobil = add("PersonMobil", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("Mobilnummer des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonEmail */
	public final SchemaTabelleSpalte col_PersonEmail = add("PersonEmail", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
	...
	public final SchemaTabelleSpalte col_PersonAnrede = add("PersonAnrede", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Anrede des Personeneintrags zur Personengruppe");

	/** Die Definition der Tabellenspalte PersonAkadGrad */
	public final SchemaTabelleSpalte col_PersonAkadGrad = add("PersonAkadGrad", SchemaDatentypen.VARCHAR, false).setDatenlaenge(15)
	...
	public final SchemaTabelleFremdschluessel fk_Personengruppen_Personen_Gruppe = addForeignKey(

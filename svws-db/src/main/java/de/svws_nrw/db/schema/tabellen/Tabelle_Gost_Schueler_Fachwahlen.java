...
public class Tabelle_Gost_Schueler_Fachwahlen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_EF1_Punkte = add("EF1_Punkte", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_EF2_Punkte = add("EF2_Punkte", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_Q11_Punkte = add("Q11_Punkte", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_Q12_Punkte = add("Q12_Punkte", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_Q21_Punkte = add("Q21_Punkte", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_Q22_Punkte = add("Q22_Punkte", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_Markiert_Q1 = add("Markiert_Q1", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setJavaComment("Gymnasiale Oberstufe - Schülerdaten - Fachwahlen - Abiturberechnung:"
					+ " Gibt an, ob das belegte Fach in der Q1.1 für die Einbringung in das Abitur markiert wurde");

	/** Die Definition der Tabellenspalte Markiert_Q2 */
	public final SchemaTabelleSpalte col_Markiert_Q2 = add("Markiert_Q2", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setJavaComment("Gymnasiale Oberstufe - Schülerdaten - Fachwahlen - Abiturberechnung:"
					+ " Gibt an, ob das belegte Fach in der Q1.2 für die Einbringung in das Abitur markiert wurde");

	/** Die Definition der Tabellenspalte Markiert_Q3 */
	public final SchemaTabelleSpalte col_Markiert_Q3 = add("Markiert_Q3", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setJavaComment("Gymnasiale Oberstufe - Schülerdaten - Fachwahlen - Abiturberechnung:"
					+ " Gibt an, ob das belegte Fach in der Q2.1 für die Einbringung in das Abitur markiert wurde");

	/** Die Definition der Tabellenspalte Markiert_Q4 */
	public final SchemaTabelleSpalte col_Markiert_Q4 = add("Markiert_Q4", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setJavaComment("Gymnasiale Oberstufe - Schülerdaten - Fachwahlen - Abiturberechnung:"
					+ " Gibt an, ob das belegte Fach in der Q2.2 für die Einbringung in das Abitur markiert wurde");

	/** Die Definition der Tabellenspalte ergebnisAbiturpruefung */
	public final SchemaTabelleSpalte col_ergebnisAbiturpruefung = add("ergebnisAbiturpruefung", SchemaDatentypen.INT, false)
			.setJavaComment("Gymnasiale Oberstufe - Schülerdaten - Fachwahlen - Abiturberechnung:"
					+ " Das Ergebnis der Abiturprüfung in einem Abiturfach (1. - 4. Fach)");

	/** Die Definition der Tabellenspalte hatMuendlichePflichtpruefung */
	public final SchemaTabelleSpalte col_hatMuendlichePflichtpruefung = add("hatMuendlichePflichtpruefung", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setJavaComment("Gymnasiale Oberstufe - Schülerdaten - Fachwahlen - Abiturberechnung:"
					+ " Gibt an, ob eine mündliche Pflichtprüfung im 1. - 3. Fach angesetzt werden muss (null - unbekannt, 0 - Nein, 1 - Ja)  ");
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Schueler_Fachwahlen_Fach_ID_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_Gost_Schueler_Fachwahlen_IDX_Schueler_ID = addIndex("Gost_Schueler_Fachwahlen_IDX_Schueler_ID",
			col_Schueler_ID
	);

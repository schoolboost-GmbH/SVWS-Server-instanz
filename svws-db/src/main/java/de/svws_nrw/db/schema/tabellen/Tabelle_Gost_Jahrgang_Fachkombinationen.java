...
public class Tabelle_Gost_Jahrgang_Fachkombinationen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Abi_Jahrgang = add("Abi_Jahrgang", SchemaDatentypen.INT, false)
			.setNotNull()
			.setDefault("-1")
			.setJavaComment("Schuljahr, in welchem der Jahrgang das Abitur macht");

	/** Die Definition der Tabellenspalte Fach1_ID */
	public final SchemaTabelleSpalte col_Fach1_ID = add("Fach1_ID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_Fach2_ID = add("Fach2_ID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_Kursart1 = add("Kursart1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
	...
	public final SchemaTabelleSpalte col_Kursart2 = add("Kursart2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
	...
	public final SchemaTabelleSpalte col_EF1 = add("EF1", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_EF2 = add("EF2", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setNotNull()
			.setDefault("1")
	...
	public final SchemaTabelleSpalte col_Q11 = add("Q11", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setNotNull()
			.setDefault("1")
	...
	public final SchemaTabelleSpalte col_Q12 = add("Q12", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setNotNull()
			.setDefault("1")
	...
	public final SchemaTabelleSpalte col_Q21 = add("Q21", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setNotNull()
			.setDefault("1")
	...
	public final SchemaTabelleSpalte col_Q22 = add("Q22", SchemaDatentypen.INT, false)
			.setConverter(Boolean01Converter.class)
			.setNotNull()
			.setDefault("1")
	...
	public final SchemaTabelleSpalte col_Hinweistext = add("Hinweistext", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setDefault("")
			.setNotNull()
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Jahrgang_Fachkombinationen_Abi_Jahrgang_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Jahrgang_Fachkombinationen_Fach1_ID_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Jahrgang_Fachkombinationen_Fach2_ID_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_Gost_Jahrgang_Fachkombinationen_IDX_Abi_Jahrgang = addIndex("Gost_Jahrgang_Fachkombinationen_IDX_Abi_Jahrgang",
			col_Abi_Jahrgang
	);

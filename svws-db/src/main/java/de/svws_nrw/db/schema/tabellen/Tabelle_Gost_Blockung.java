...
public class Tabelle_Gost_Blockung extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Name = add("Name", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Blockung_Abi_Jahrgang_FK = addForeignKey(

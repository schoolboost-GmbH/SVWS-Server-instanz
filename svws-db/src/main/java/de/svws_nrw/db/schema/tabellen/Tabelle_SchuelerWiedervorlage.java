...
public class Tabelle_SchuelerWiedervorlage extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_AngelegtAm = add("AngelegtAm", SchemaDatentypen.DATETIME, false)
			.setJavaComment("Datum Anlage des Wiedervorlageeintrags");

	/** Die Definition der Tabellenspalte WiedervorlageAm */
	public final SchemaTabelleSpalte col_WiedervorlageAm = add("WiedervorlageAm", SchemaDatentypen.DATETIME, false)
			.setJavaComment("Datum Wiedervorlage am");

	/** Die Definition der Tabellenspalte ErledigtAm */
	public final SchemaTabelleSpalte col_ErledigtAm = add("ErledigtAm", SchemaDatentypen.DATETIME, false)
			.setJavaComment("Datum Erledigung  des Wiedervorlageeintrags");

	/** Die Definition der Tabellenspalte User_ID */
	public final SchemaTabelleSpalte col_User_ID = add("User_ID", SchemaDatentypen.BIGINT, false)
			.setJavaComment("UserID  des Wiedervorlageeintrags");

	/** Die Definition der Tabellenspalte Sekretariat */
	public final SchemaTabelleSpalte col_Sekretariat = add("Sekretariat", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleSpalte col_NichtLoeschen = add("NichtLoeschen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerWiedervorlage_Benutzer_FK = addForeignKey(

...
public class Tabelle_LehrerFunktionen extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_LehrerFunktionen_Abschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_LehrerFunktionen_Funktion_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_LehrerFunktionen_Lehrer_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_LehrerFunktionen_UC1 = addUniqueIndex("LehrerFunktionen_UC1",
			col_Abschnitt_ID,
			col_Funktion_ID

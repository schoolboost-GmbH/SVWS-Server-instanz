...
public class Tabelle_Client_Konfiguration_Benutzer extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_ClientKonfigurationBenutzer_Benutzer_FK = addForeignKey(
	...
	public Tabelle_Client_Konfiguration_Benutzer() {
		...
		setJavaComment("Tabelle für das Speichern von Client-Konfigurationen als Key-Value-Paare. Dabei werden über das Feld App unterschiedliche"
				+ " Client-Anwendungen unterstützt und über das Feld Benutzer eine Benutzerspezifische Speicherung.");
	}

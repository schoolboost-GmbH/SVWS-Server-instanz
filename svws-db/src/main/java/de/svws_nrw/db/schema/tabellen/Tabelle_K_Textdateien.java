...
public class Tabelle_K_Textdateien extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Bezeichnung = add("Bezeichnung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(32)
	...
	public final SchemaTabelleSpalte col_Text_ID = add("Text_ID", SchemaDatentypen.BIGINT, false)
			.setNotNull()
			.setJavaComment("TextID des Textes der zum Ersatz für txt-Dateien genutzt wird");

	/** Die Definition der Tabellenspalte Text_Body */
	public final SchemaTabelleSpalte col_Text_Body = add("Text_Body", SchemaDatentypen.TEXT, false)
	...
	public final SchemaTabelleSpalte col_Sortierung = add("Sortierung", SchemaDatentypen.SMALLINT, false)

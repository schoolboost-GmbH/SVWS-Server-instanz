...
public class Tabelle_Stundenplan_Zeitraster extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_Stundenplan_Zeitraster_Stundenplan_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_Stundenplan_Zeitraster_UC1 = addUniqueIndex("Stundenplan_Zeitraster_UC1",
			col_Stunde,
			col_Stundenplan_ID,
			col_Tag
	);
	...
	public Tabelle_Stundenplan_Zeitraster() {
		...
		setJavaComment("Enthält das Zeitraster eines Stundenplan. Dieses wird üblicherweise aus der Tabelle Katalog_Zeitraster übernommen und hier"
				+ " zwischengespeichert. Änderungen im Katalog werden nicht hierhin übernommen.");
	}

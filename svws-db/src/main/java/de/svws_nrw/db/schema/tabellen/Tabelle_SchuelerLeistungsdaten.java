...
public class Tabelle_SchuelerLeistungsdaten extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_NotenKrzQuartal = add("NotenKrzQuartal", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setJavaComment("Das Notenkürzel der Quartals-Note");

	/** Die Definition der Tabellenspalte Warnung */
	public final SchemaTabelleSpalte col_Warnung = add("Warnung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_Warndatum = add("Warndatum", SchemaDatentypen.DATE, false)
	...
	public final SchemaTabelleSpalte col_Wochenstunden = add("Wochenstunden", SchemaDatentypen.SMALLINT, false)
			.setJavaComment("gibt die Wochenstunden");

	/** Die Definition der Tabellenspalte AbiZeugnis */
	public final SchemaTabelleSpalte col_AbiZeugnis = add("AbiZeugnis", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("DEPRECATED: Relikt aus Winschild nicht mehr benötigt");

	/** Die Definition der Tabellenspalte Prognose */
	public final SchemaTabelleSpalte col_Prognose = add("Prognose", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setJavaComment("DEPRECATED: Relikt aus Winschild nicht mehr benötigt");

	/** Die Definition der Tabellenspalte FehlStd */
	public final SchemaTabelleSpalte col_FehlStd = add("FehlStd", SchemaDatentypen.SMALLINT, false)
			.setJavaComment("Fachbezogene Fehlstunden");

	/** Die Definition der Tabellenspalte uFehlStd */
	public final SchemaTabelleSpalte col_uFehlStd = add("uFehlStd", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_Lernentw = add("Lernentw", SchemaDatentypen.TEXT, false)
			.setJavaComment("Text für Fachbezogene Lernentwicklung Bemerkung");

	/** Die Definition der Tabellenspalte Gekoppelt */
	public final SchemaTabelleSpalte col_Gekoppelt = add("Gekoppelt", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("DEPRECATED: Relikt aus Winschild nicht mehr benötigt");

	/** Die Definition der Tabellenspalte VorherAbgeschl */
	public final SchemaTabelleSpalte col_VorherAbgeschl = add("VorherAbgeschl", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Gibt an ob das Fach Epochal war oder ist");

	/** Die Definition der Tabellenspalte AbschlussJahrgang */
	public final SchemaTabelleSpalte col_AbschlussJahrgang = add("AbschlussJahrgang", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_HochrechnungStatus = add("HochrechnungStatus", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setJavaComment("DEPRECATED: Hier wurde früher gespeichert, ob es sich um eine temporäre oder dauerhafte Hochrechnung handelt. Eine Hochrechnung"
					+ " ist nur noch am BK möglich und immer temporär.");

	/** Die Definition der Tabellenspalte SchulNr */
	public final SchemaTabelleSpalte col_SchulNr = add("SchulNr", SchemaDatentypen.INT, false)
			.setJavaComment("Schulnummer bei externem Unterricht");

	/** Die Definition der Tabellenspalte Zusatzkraft_ID */
	public final SchemaTabelleSpalte col_Zusatzkraft_ID = add("Zusatzkraft_ID", SchemaDatentypen.BIGINT, false)
			.setJavaComment("Die Lehrer-ID der Zusatzkraft");

	/** Die Definition der Tabellenspalte WochenstdZusatzkraft */
	public final SchemaTabelleSpalte col_WochenstdZusatzkraft = add("WochenstdZusatzkraft", SchemaDatentypen.INT, false)
			.setJavaComment("Wochenstunden Zusatzkraft");

	/** Die Definition der Tabellenspalte Prf10Fach */
	public final SchemaTabelleSpalte col_Prf10Fach = add("Prf10Fach", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Ist Fach für ZP10 / ZK10");

	/** Die Definition der Tabellenspalte AufZeugnis */
	public final SchemaTabelleSpalte col_AufZeugnis = add("AufZeugnis", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
			.setJavaComment("Fach kommt aufs Zeugnnis Ja Nein");

	/** Die Definition der Tabellenspalte Gewichtung */
	public final SchemaTabelleSpalte col_Gewichtung = add("Gewichtung", SchemaDatentypen.INT, false)
			.setDefault("1")
	...
	public final SchemaTabelleSpalte col_NoteAbschlussBA = add("NoteAbschlussBA", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setJavaComment("Beim BK wird hier die Note Berufsabschluss eingetragen. Ist vermutl. nicht mehr notwendig, wenn alle Zeugnisse sich aus dem"
					+ " BKAbschluss-Fächern bedienen");

	/** Die Definition der Tabellenspalte Umfang */
	public final SchemaTabelleSpalte col_Umfang = add("Umfang", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
	...
	public final SchemaTabelleSpalte col_Zusatzkraft = add("Zusatzkraft", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerLeistungsdaten_Abschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerLeistungsdaten_Fach_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerLeistungsdaten_Lehrer_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerLeistungsdaten_Lehrer_Zusatzkraft_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerLeistungsdaten_Kurs_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_SchuelerLeistungsdaten_IDX1 = addIndex("SchuelerLeistungsdaten_IDX1",
			col_Kurs_ID
	);

	/** Die Definition des Non-Unique-Index SchuelerLeistungsdaten_IDX2 */
	public final SchemaTabelleIndex index_SchuelerLeistungsdaten_IDX2 = addIndex("SchuelerLeistungsdaten_IDX2",
			col_Fach_ID
	);

	/** Die Definition des Non-Unique-Index SchuelerLeistungsdaten_IDX3 */
	public final SchemaTabelleIndex index_SchuelerLeistungsdaten_IDX3 = addIndex("SchuelerLeistungsdaten_IDX3",
			col_Fachlehrer_ID
	);


	/** Die Definition des Non-Unique-Index SchuelerLeistungsdaten_IDX_Abschnitt_ID */
	public final SchemaTabelleIndex index_SchuelerLeistungsdaten_IDX_Abschnitt_ID = addIndex("SchuelerLeistungsdaten_IDX_Abschnitt_ID",
			col_Abschnitt_ID
	);

	/** Die Definition des Non-Unique-Index SchuelerLeistungsdaten_IDX_Fach_ID */
	public final SchemaTabelleIndex index_SchuelerLeistungsdaten_IDX_Fach_ID = addIndex("SchuelerLeistungsdaten_IDX_Fach_ID",
			col_Fach_ID
	);

	/** Die Definition des Non-Unique-Index SchuelerLeistungsdaten_IDX_Kurs_ID */
	public final SchemaTabelleIndex index_SchuelerLeistungsdaten_IDX_Kurs_ID = addIndex("SchuelerLeistungsdaten_IDX_Kurs_ID",
			col_Kurs_ID
	);

	/** Die Definition des Non-Unique-Index SchuelerLeistungsdaten_IDX_Fachlehrer_ID */
	public final SchemaTabelleIndex index_SchuelerLeistungsdaten_IDX_Fachlehrer_ID = addIndex("SchuelerLeistungsdaten_IDX_Fachlehrer_ID",
			col_Fachlehrer_ID
	);

	/** Die Definition des Unique-Index SchuelerLeistungsdaten_UC1 */
	public final SchemaTabelleUniqueIndex unique_SchuelerLeistungsdaten_UC1 = addUniqueIndex("SchuelerLeistungsdaten_UC1",
			col_Abschnitt_ID,
			col_Fach_ID,
			col_Kurs_ID,
			col_Kursart,

...
public class Tabelle_Floskelgruppen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Hauptgruppe = add("Hauptgruppe", SchemaDatentypen.VARCHAR, false).setDatenlaenge(4)
	...
	public final SchemaTabelleSpalte col_Farbe = add("Farbe", SchemaDatentypen.INT, false)

...
public class Tabelle_SchuelerListe extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Erzeuger = add("Erzeuger", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaComment("UserID Erzeuger der individuellen Schülerliste");

	/** Die Definition der Tabellenspalte Privat */
	public final SchemaTabelleSpalte col_Privat = add("Privat", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
	...
	public final SchemaTabelleUniqueIndex unique_SchuelerListe_UC1 = addUniqueIndex("SchuelerListe_UC1",
			col_Bezeichnung
	);

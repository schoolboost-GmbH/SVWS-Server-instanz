...
public class Tabelle_SchuelerBKFaecher extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_FachSchriftlich = add("FachSchriftlich", SchemaDatentypen.CHAR, false).setDatenlaenge(1)
	...
	public final SchemaTabelleSpalte col_FachSchriftlichBA = add("FachSchriftlichBA", SchemaDatentypen.CHAR, false).setDatenlaenge(1)
			.setConverter(BooleanPlusMinusConverter.class)
	...
	public final SchemaTabelleSpalte col_Vornote = add("Vornote", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_NoteSchriftlich = add("NoteSchriftlich", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setJavaComment("Schriftliche Note  des Facheintrags für den BKAbschlussReiter");

	/** Die Definition der Tabellenspalte MdlPruefung */
	public final SchemaTabelleSpalte col_MdlPruefung = add("MdlPruefung", SchemaDatentypen.CHAR, false).setDatenlaenge(1)
			.setConverter(BooleanPlusMinusConverter.class)
	...
	public final SchemaTabelleSpalte col_MdlPruefungFW = add("MdlPruefungFW", SchemaDatentypen.CHAR, false).setDatenlaenge(1)
			.setConverter(BooleanPlusMinusConverter.class)
	...
	public final SchemaTabelleSpalte col_NoteMuendlich = add("NoteMuendlich", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleSpalte col_NoteAbschluss = add("NoteAbschluss", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setJavaComment("Abschlussnote  des Facheintrags für den BKAbschlussReiter");

	/** Die Definition der Tabellenspalte NotePrfGesamt */
	public final SchemaTabelleSpalte col_NotePrfGesamt = add("NotePrfGesamt", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerBKFaecher_Schuljahreabschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerBKFaecher_Fach_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerBKFaecher_Schueler_FK = addForeignKey(

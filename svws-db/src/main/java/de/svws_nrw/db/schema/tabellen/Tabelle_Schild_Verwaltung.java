...
public class Tabelle_Schild_Verwaltung extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_BackupDatum = add("BackupDatum", SchemaDatentypen.DATETIME, false)
			.setJavaComment("Wird das Dateum des letzten Backupo eingetragen.");

	/** Die Definition der Tabellenspalte AutoBerechnung */
	public final SchemaTabelleSpalte col_AutoBerechnung = add("AutoBerechnung", SchemaDatentypen.DATETIME, false)
	...
	public final SchemaTabelleSpalte col_DatumStatkue = add("DatumStatkue", SchemaDatentypen.DATETIME, false)
			.setJavaComment("DEPRECATED Datum der Statkue wird nicht benutzt.");

	/** Die Definition der Tabellenspalte DatumSchildIntern */
	public final SchemaTabelleSpalte col_DatumSchildIntern = add("DatumSchildIntern", SchemaDatentypen.DATETIME, false)
			.setJavaComment("DEPRECATED Datum der Schildintern wird nicht benutzt.");

	/** Die Definition der Tabellenspalte Bescheinigung */
	public final SchemaTabelleSpalte col_Bescheinigung = add("Bescheinigung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Pfad zu der ausgewählten Reportvorlage");

	/** Die Definition der Tabellenspalte Stammblatt */
	public final SchemaTabelleSpalte col_Stammblatt = add("Stammblatt", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Pfad zu der ausgewählten Reportvorlage");

	/** Die Definition der Tabellenspalte DatenGeprueft */
	public final SchemaTabelleSpalte col_DatenGeprueft = add("DatenGeprueft", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_Version = add("Version", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
	...
	public final SchemaTabelleSpalte col_DatumLoeschfristHinweisDeaktiviert = add("DatumLoeschfristHinweisDeaktiviert", SchemaDatentypen.DATETIME, false)
	...
	public final SchemaTabelleSpalte col_DatumLoeschfristHinweisDeaktiviertUserID = add("DatumLoeschfristHinweisDeaktiviertUserID", SchemaDatentypen.BIGINT, false)
			.setJavaComment("Gibt an welcher User den Hiweis deaktiviert hat.");

	/** Die Definition der Tabellenspalte DatumDatenGeloescht */
	public final SchemaTabelleSpalte col_DatumDatenGeloescht = add("DatumDatenGeloescht", SchemaDatentypen.DATETIME, false)
	...
	public final SchemaTabelleFremdschluessel fk_Schild_Verwaltung_Loeschfrist_deaktiviert_durch_Benutzer_FK = addForeignKey(

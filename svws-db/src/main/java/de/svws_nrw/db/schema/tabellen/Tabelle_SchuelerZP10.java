...
public class Tabelle_SchuelerZP10 extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerZP10_Schuljahreabschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerZP10_Fach_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerZP10_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_SchuelerZP10_IDX1 = addIndex("SchuelerZP10_IDX1",
			col_Schueler_ID
	);

	/** Die Definition des Non-Unique-Index SchuelerZP10_IDX2 */
	public final SchemaTabelleIndex index_SchuelerZP10_IDX2 = addIndex("SchuelerZP10_IDX2",
			col_Schuljahresabschnitts_ID
	);

	/** Die Definition des Non-Unique-Index SchuelerZP10_IDX3 */
	public final SchemaTabelleIndex index_SchuelerZP10_IDX3 = addIndex("SchuelerZP10_IDX3",
			col_Fach_ID
	);

	/** Die Definition des Non-Unique-Index SchuelerZP10_IDX4 */
	public final SchemaTabelleIndex index_SchuelerZP10_IDX4 = addIndex("SchuelerZP10_IDX4",
			col_Fachlehrer_ID
	);


	/** Die Definition des Unique-Index SchuelerZP10_UC1 */
	public final SchemaTabelleUniqueIndex unique_SchuelerZP10_UC1 = addUniqueIndex("SchuelerZP10_UC1",
			col_Schueler_ID,
			col_Schuljahresabschnitts_ID,
			col_Fach_ID
	);

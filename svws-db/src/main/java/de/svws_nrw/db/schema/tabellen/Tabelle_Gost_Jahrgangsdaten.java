...
public class Tabelle_Gost_Jahrgangsdaten extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_ZusatzkursGEVorhanden = add("ZusatzkursGEVorhanden", SchemaDatentypen.INT, false)
			.setDefault("1")
	...
	public final SchemaTabelleSpalte col_ZusatzkursGEErstesHalbjahr = add("ZusatzkursGEErstesHalbjahr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(4)
			.setDefault("Q2.1")
	...
	public final SchemaTabelleSpalte col_ZusatzkursSWVorhanden = add("ZusatzkursSWVorhanden", SchemaDatentypen.INT, false)
			.setDefault("1")
			.setConverter(Boolean01Converter.class)
	...
	public final SchemaTabelleSpalte col_ZusatzkursSWErstesHalbjahr = add("ZusatzkursSWErstesHalbjahr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(4)
			.setDefault("Q2.1")
	...
	public final SchemaTabelleSpalte col_TextBeratungsbogen = add("TextBeratungsbogen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2000)
	...
	public final SchemaTabelleSpalte col_TextMailversand = add("TextMailversand", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2000)
	...
	public final SchemaTabelleUniqueIndex unique_Gost_Jahrgangsdaten_UC_Abi_Jahrgang = addUniqueIndex("Gost_Jahrgangsdaten_UC_Abi_Jahrgang",
			col_Abi_Jahrgang
	);

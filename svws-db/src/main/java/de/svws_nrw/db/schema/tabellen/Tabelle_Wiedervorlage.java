...
public class Tabelle_Wiedervorlage extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_PersonTyp = add("PersonTyp", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
	...
	public final SchemaTabelleSpalte col_tsAngelegt = add("tsAngelegt", SchemaDatentypen.DATETIME, false)
	...
	public final SchemaTabelleSpalte col_tsWiedervorlage = add("tsWiedervorlage", SchemaDatentypen.DATETIME, false)
	...
	public final SchemaTabelleSpalte col_tsErledigt = add("tsErledigt", SchemaDatentypen.DATETIME, false)
	...
	public final SchemaTabelleSpalte col_AutomatischErledigt = add("AutomatischErledigt", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
	...
	public final SchemaTabelleFremdschluessel fk_Wiedervorlage_Lehrer_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Wiedervorlage_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Wiedervorlage_Erzieher_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Wiedervorlage_Benutzer_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Wiedervorlage_Benutzer_Erledigt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Wiedervorlage_Benutzergruppe_FK = addForeignKey(

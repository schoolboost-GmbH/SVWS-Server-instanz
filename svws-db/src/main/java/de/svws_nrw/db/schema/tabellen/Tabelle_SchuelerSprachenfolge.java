...
public class Tabelle_SchuelerSprachenfolge extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_ASDJahrgangVon = add("ASDJahrgangVon", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setRevision(SchemaRevisionen.REV_1)
			.setJavaComment("ASDJahrgang Beginn des Sprachenfolgeeintrags");

	/** Die Definition der Tabellenspalte ASDJahrgangBis */
	public final SchemaTabelleSpalte col_ASDJahrgangBis = add("ASDJahrgangBis", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setRevision(SchemaRevisionen.REV_1)
			.setJavaComment("ASDJahrgang Ende des Sprachenfolgeeintrags");

	/** Die Definition der Tabellenspalte AbschnittVon */
	public final SchemaTabelleSpalte col_AbschnittVon = add("AbschnittVon", SchemaDatentypen.SMALLINT, false)
			.setJavaComment("Abschnitt Beginn des Sprachenfolgeeintrags");

	/** Die Definition der Tabellenspalte AbschnittBis */
	public final SchemaTabelleSpalte col_AbschnittBis = add("AbschnittBis", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_KleinesLatinumErreicht = add("KleinesLatinumErreicht", SchemaDatentypen.INT, false)
			.setRevision(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleSpalte col_LatinumErreicht = add("LatinumErreicht", SchemaDatentypen.INT, false)
			.setRevision(SchemaRevisionen.REV_1)
			.setConverter(Boolean01Converter.class)
			.setJavaComment("Gibt an, ob der Schüler das Latinum erreicht hat");

	/** Die Definition der Tabellenspalte GraecumErreicht */
	public final SchemaTabelleSpalte col_GraecumErreicht = add("GraecumErreicht", SchemaDatentypen.INT, false)
			.setRevision(SchemaRevisionen.REV_1)
			.setConverter(Boolean01Converter.class)
			.setJavaComment("Gibt an, ob der Schüler das Graecum erreicht hat");

	/** Die Definition der Tabellenspalte HebraicumErreicht */
	public final SchemaTabelleSpalte col_HebraicumErreicht = add("HebraicumErreicht", SchemaDatentypen.INT, false)
			.setRevision(SchemaRevisionen.REV_1)
			.setConverter(Boolean01Converter.class)
	...
	public final SchemaTabelleSpalte col_Reihenfolge = add("Reihenfolge", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleSpalte col_JahrgangVon = add("JahrgangVon", SchemaDatentypen.SMALLINT, false)
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleSpalte col_JahrgangBis = add("JahrgangBis", SchemaDatentypen.SMALLINT, false)
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerSprachenfolge_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleIndex index_SchuelerSprachenfolge_IDX1 = addIndex("SchuelerSprachenfolge_IDX1",
			col_Schueler_ID
	);

	/** Die Definition des Unique-Index SchuelerSprachenfolge_UC1 */
	public final SchemaTabelleUniqueIndex unique_SchuelerSprachenfolge_UC1 = addUniqueIndex("SchuelerSprachenfolge_UC1",
			col_Schueler_ID,
			col_Sprache

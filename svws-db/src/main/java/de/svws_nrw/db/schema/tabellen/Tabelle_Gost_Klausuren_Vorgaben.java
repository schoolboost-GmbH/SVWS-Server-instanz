...
public class Tabelle_Gost_Klausuren_Vorgaben extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Halbjahr = add("Halbjahr", SchemaDatentypen.INT, false)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_Dauer = add("Dauer", SchemaDatentypen.INT, false)
			.setNotNull()
			.setJavaComment("Das Dauer der Klausur/Prüfung in Minuten");

	/** Die Definition der Tabellenspalte Auswahlzeit */
	public final SchemaTabelleSpalte col_Auswahlzeit = add("Auswahlzeit", SchemaDatentypen.INT, false)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_IstAudioNotwendig = add("IstAudioNotwendig", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
			.setConverter(Boolean01Converter.class)
	...
	public final SchemaTabelleSpalte col_IstVideoNotwendig = add("IstVideoNotwendig", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
			.setConverter(Boolean01Converter.class)
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Klausuren_Vorgaben_Abi_Jahrgang_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_Gost_Klausuren_Vorgaben_Fach_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_Gost_Klausuren_Vorgaben_UC1 = addUniqueIndex("Gost_Klausuren_Vorgaben_UC1",
	...
	public final SchemaTabelleIndex index_Gost_Klausuren_Vorgaben_IDX_Abi_Jahrgang = addIndex("Gost_Klausuren_Vorgaben_IDX_Abi_Jahrgang",
			col_Abi_Jahrgang
	);

...
public class Tabelle_LehrerAnrechnung extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_LehrerAnrechnung_Abschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_LehrerAnrechnung_Lehrer_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_LehrerAnrechnung_UC1 = addUniqueIndex("LehrerAnrechnung_UC1",
			col_Abschnitt_ID,

...
public class Tabelle_K_AllgAdresse extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_AdressArt_ID = add("AdressArt_ID", SchemaDatentypen.BIGINT, false)
	...
	public final SchemaTabelleSpalte col_AllgAdrAdressArt = add("AllgAdrAdressArt", SchemaDatentypen.VARCHAR, false).setDatenlaenge(30)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaComment("DEPRECATED Die Bezeichnung der Adressart des Betriebs");

	/** Die Definition der Tabellenspalte AllgAdrName1 */
	public final SchemaTabelleSpalte col_AllgAdrName1 = add("AllgAdrName1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaName("name1")
			.setJavaComment("Name1 des Betriebs");

	/** Die Definition der Tabellenspalte AllgAdrName2 */
	public final SchemaTabelleSpalte col_AllgAdrName2 = add("AllgAdrName2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaName("name2")
			.setJavaComment("Name2 des Betriebs");

	/** Die Definition der Tabellenspalte AllgAdrStrasse */
	public final SchemaTabelleSpalte col_AllgAdrStrasse = add("AllgAdrStrasse", SchemaDatentypen.VARCHAR, false).setDatenlaenge(55)
			.setVeraltet(SchemaRevisionen.REV_1)
			.setJavaName("strasse")
			.setJavaComment("Straße des Betriebs");

	/** Die Definition der Tabellenspalte AllgAdrStrassenname */
	public final SchemaTabelleSpalte col_AllgAdrStrassenname = add("AllgAdrStrassenname", SchemaDatentypen.VARCHAR, false).setDatenlaenge(55)
			.setJavaName("strassenname")
			.setJavaComment("Straßenname des Betriebsdatensatz");

	/** Die Definition der Tabellenspalte AllgAdrHausNr */
	public final SchemaTabelleSpalte col_AllgAdrHausNr = add("AllgAdrHausNr", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaName("hausnr")
			.setJavaComment("Hausnummer wenn getrennt gespeichert");

	/** Die Definition der Tabellenspalte AllgAdrHausNrZusatz */
	public final SchemaTabelleSpalte col_AllgAdrHausNrZusatz = add("AllgAdrHausNrZusatz", SchemaDatentypen.VARCHAR, false).setDatenlaenge(30)
	...
	public final SchemaTabelleSpalte col_AllgAdrOrt_ID = add("AllgAdrOrt_ID", SchemaDatentypen.BIGINT, false)
			.setJavaName("ort_id")
			.setJavaComment("OrtID des Betriebs");

	/** Die Definition der Tabellenspalte AllgOrtsteil_ID */
	public final SchemaTabelleSpalte col_AllgOrtsteil_ID = add("AllgOrtsteil_ID", SchemaDatentypen.BIGINT, false)
			.setJavaName("ortsteil_id")
			.setJavaComment("OrtsteilID des Betriebs");

	/** Die Definition der Tabellenspalte AllgAdrPLZ */
	public final SchemaTabelleSpalte col_AllgAdrPLZ = add("AllgAdrPLZ", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
	...
	public final SchemaTabelleSpalte col_AllgAdrTelefon1 = add("AllgAdrTelefon1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaName("telefon1")
			.setJavaComment("Telefonnummer1 des Betriebs");

	/** Die Definition der Tabellenspalte AllgAdrTelefon2 */
	public final SchemaTabelleSpalte col_AllgAdrTelefon2 = add("AllgAdrTelefon2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaName("telefon2")
			.setJavaComment("Telefonnummer2 des Betriebs");

	/** Die Definition der Tabellenspalte AllgAdrFax */
	public final SchemaTabelleSpalte col_AllgAdrFax = add("AllgAdrFax", SchemaDatentypen.VARCHAR, false).setDatenlaenge(20)
			.setJavaName("fax")
			.setJavaComment("Faxnummer des Betriebs");

	/** Die Definition der Tabellenspalte AllgAdrEmail */
	public final SchemaTabelleSpalte col_AllgAdrEmail = add("AllgAdrEmail", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaName("email")
			.setJavaComment("E-MailAdresse des Betriebes");

	/** Die Definition der Tabellenspalte AllgAdrBemerkungen */
	public final SchemaTabelleSpalte col_AllgAdrBemerkungen = add("AllgAdrBemerkungen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleSpalte col_AllgAdrAusbildungsBetrieb = add("AllgAdrAusbildungsBetrieb", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_AllgAdrBietetPraktika = add("AllgAdrBietetPraktika", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_AllgAdrBranche = add("AllgAdrBranche", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaName("branche")
			.setJavaComment("Brache des Betriebs");

	/** Die Definition der Tabellenspalte AllgAdrZusatz1 */
	public final SchemaTabelleSpalte col_AllgAdrZusatz1 = add("AllgAdrZusatz1", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaName("zusatz1")
			.setJavaComment("Adresszusatz zum Betrieb");

	/** Die Definition der Tabellenspalte AllgAdrZusatz2 */
	public final SchemaTabelleSpalte col_AllgAdrZusatz2 = add("AllgAdrZusatz2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaName("zusatz2")
	...
	public final SchemaTabelleSpalte col_Massnahmentraeger = add("Massnahmentraeger", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Bezeichnung des Maßnahmenträgers");

	/** Die Definition der Tabellenspalte BelehrungISG */
	public final SchemaTabelleSpalte col_BelehrungISG = add("BelehrungISG", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
	...
	public final SchemaTabelleSpalte col_ErwFuehrungszeugnis = add("ErwFuehrungszeugnis", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("Wird für diesen Betrieb ein Erweitertes Führungszeugnis benötigt?");

	/** Die Definition der Tabellenspalte ExtID */
	public final SchemaTabelleSpalte col_ExtID = add("ExtID", SchemaDatentypen.VARCHAR, false).setDatenlaenge(50)
			.setJavaComment("Externe ID des Betriebsdatensatzes");


	/** Die Definition des Fremdschlüssels K_AllgAdresse_K_Adressart_FK */
	public final SchemaTabelleFremdschluessel fk_K_AllgAdresse_K_Adressart_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_K_AllgAdresse_Ort_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_K_AllgAdresse_Ortsteil_FK = addForeignKey(

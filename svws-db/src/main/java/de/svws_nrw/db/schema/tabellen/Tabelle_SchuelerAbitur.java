...
public class Tabelle_SchuelerAbitur extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_FA_Fach = add("FA_Fach", SchemaDatentypen.VARCHAR, false).setDatenlaenge(130)
			.setJavaName("FacharbeitFach")
			.setJavaComment("BK: Facharbeit – Fach");

	/** Die Definition der Tabellenspalte FA_Punkte */
	public final SchemaTabelleSpalte col_FA_Punkte = add("FA_Punkte", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_FehlStd = add("FehlStd", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_uFehlStd = add("uFehlStd", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Latinum = add("Latinum", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_KlLatinum = add("KlLatinum", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleSpalte col_Graecum = add("Graecum", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleSpalte col_Hebraicum = add("Hebraicum", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setVeraltet(SchemaRevisionen.REV_1)
	...
	public final SchemaTabelleSpalte col_FranzBilingual = add("FranzBilingual", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
	...
	public final SchemaTabelleSpalte col_BesondereLernleistung = add("BesondereLernleistung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("-")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
	...
	public final SchemaTabelleSpalte col_AnzRelLK = add("AnzRelLK", SchemaDatentypen.SMALLINT, false)
			.setJavaName("-")
			.setJavaComment("DEPRECATED, nur alte APO für altes G9");

	/** Die Definition der Tabellenspalte AnzRelGK */
	public final SchemaTabelleSpalte col_AnzRelGK = add("AnzRelGK", SchemaDatentypen.SMALLINT, false)
			.setJavaName("-")
			.setJavaComment("DEPRECATED, nur alte APO für altes G9");

	/** Die Definition der Tabellenspalte AnzRelOK */
	public final SchemaTabelleSpalte col_AnzRelOK = add("AnzRelOK", SchemaDatentypen.SMALLINT, false)
			.setJavaName("-")
			.setJavaComment("DEPRECATED, nur alte APO für altes G9");

	/** Die Definition der Tabellenspalte AnzDefLK */
	public final SchemaTabelleSpalte col_AnzDefLK = add("AnzDefLK", SchemaDatentypen.SMALLINT, false)
			.setJavaName("-")
			.setJavaComment("DEPRECATED, nur alte APO für altes G9");

	/** Die Definition der Tabellenspalte AnzDefGK */
	public final SchemaTabelleSpalte col_AnzDefGK = add("AnzDefGK", SchemaDatentypen.SMALLINT, false)
			.setJavaName("-")
			.setJavaComment("DEPRECATED, nur alte APO für altes G9");

	/** Die Definition der Tabellenspalte Thema_PJK */
	public final SchemaTabelleSpalte col_Thema_PJK = add("Thema_PJK", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleSpalte col_FS2_SekI_Manuell = add("FS2_SekI_Manuell", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("FremdspracheSekIManuellGeprueft")
			.setConverter(BooleanPlusMinusDefaultMinusConverter.class)
			.setJavaComment("true, falls die zweite Fremsprache in der Sekundarstufe 1 manuell geprüft wurde und vom Algorithmus als gegeben angesehen"
					+ " werden kann.");

	/** Die Definition der Tabellenspalte Kurse_I */
	public final SchemaTabelleSpalte col_Kurse_I = add("Kurse_I", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Defizite_I = add("Defizite_I", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_LK_Defizite_I = add("LK_Defizite_I", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_AnzahlKurse_0 = add("AnzahlKurse_0", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Punktsumme_I = add("Punktsumme_I", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Durchschnitt_I = add("Durchschnitt_I", SchemaDatentypen.FLOAT, false)
	...
	public final SchemaTabelleSpalte col_SummeGK = add("SummeGK", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_SummeLK = add("SummeLK", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_SummenOK = add("SummenOK", SchemaDatentypen.SMALLINT, false)
			.setJavaName("-")
			.setJavaComment("DEPRECATED: Punktsummen OK für alte APO für altes G9 (1: , NULL: )");

	/** Die Definition der Tabellenspalte Zugelassen */
	public final SchemaTabelleSpalte col_Zugelassen = add("Zugelassen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
			.setJavaName("BlockI_HatZulassung")
			.setJavaComment("Block I: Gibt an, ob der Schüler zu den Abiturprüfungen zugelassen ist, d.h. die Bedingungen für Block I erfüllt hat"
					+ " (+: Ja, -: Nein, R: Freiwilliger Rücktritt)");

	/** Die Definition der Tabellenspalte BLL_Art */
	public final SchemaTabelleSpalte col_BLL_Art = add("BLL_Art", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("K")
	...
	public final SchemaTabelleSpalte col_BLL_Punkte = add("BLL_Punkte", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Thema_BLL = add("Thema_BLL", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
	...
	public final SchemaTabelleSpalte col_Punktsumme_II = add("Punktsumme_II", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Defizite_II = add("Defizite_II", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_LK_Defizite_II = add("LK_Defizite_II", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_PruefungBestanden = add("PruefungBestanden", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_Note = add("Note", SchemaDatentypen.VARCHAR, false).setDatenlaenge(3)
	...
	public final SchemaTabelleSpalte col_GesamtPunktzahl = add("GesamtPunktzahl", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_Notensprung = add("Notensprung", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleSpalte col_FehlendePunktzahl = add("FehlendePunktzahl", SchemaDatentypen.SMALLINT, false)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerAbitur_Schuljahreabschnitt_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerAbitur_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_SchuelerAbitur_UC1 = addUniqueIndex("SchuelerAbitur_UC1",
			col_Schueler_ID
	);

...
public class Tabelle_EigeneSchule_Schulformen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_SF_SGL = add("SF_SGL", SchemaDatentypen.VARCHAR, false).setDatenlaenge(5)
			.setJavaComment("Statistikkürzel SchulformSchulgliederung");

	/** Die Definition der Tabellenspalte Schulform */
	public final SchemaTabelleSpalte col_Schulform = add("Schulform", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Schulform der SGL");

	/** Die Definition der Tabellenspalte DoppelQualifikation */
	public final SchemaTabelleSpalte col_DoppelQualifikation = add("DoppelQualifikation", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("-")
	...
	public final SchemaTabelleSpalte col_BKIndex = add("BKIndex", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_Schulform2 = add("Schulform2", SchemaDatentypen.VARCHAR, false).setDatenlaenge(100)
			.setJavaComment("Schulform2 zur SGL");


	/** Die Definition des Unique-Index EigeneSchule_Schulformen_UC1 */
	public final SchemaTabelleUniqueIndex unique_EigeneSchule_Schulformen_UC1 = addUniqueIndex("EigeneSchule_Schulformen_UC1",
			col_SGL);

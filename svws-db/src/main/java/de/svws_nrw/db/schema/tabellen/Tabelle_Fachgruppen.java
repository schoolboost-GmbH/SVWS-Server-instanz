...
public class Tabelle_Fachgruppen extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Fachbereich = add("Fachbereich", SchemaDatentypen.INT, false)
			.setJavaComment("Fachbereich (Nr) der Fachgruppe aus Lupo");

	/** Die Definition der Tabellenspalte SchildFgID */
	public final SchemaTabelleSpalte col_SchildFgID = add("SchildFgID", SchemaDatentypen.BIGINT, false)
			.setJavaComment("Fachgruppen ID aus SchildNRW");

	/** Die Definition der Tabellenspalte FG_Bezeichnung */
	public final SchemaTabelleSpalte col_FG_Bezeichnung = add("FG_Bezeichnung", SchemaDatentypen.VARCHAR, false).setDatenlaenge(80)
			.setNotNull()
			.setJavaComment("Bezeichnung der Fachgruppe");

	/** Die Definition der Tabellenspalte FG_Kuerzel */
	public final SchemaTabelleSpalte col_FG_Kuerzel = add("FG_Kuerzel", SchemaDatentypen.VARCHAR, false).setDatenlaenge(10)
			.setJavaComment("Kürzel der Fachgruppe");

	/** Die Definition der Tabellenspalte Schulformen */
	public final SchemaTabelleSpalte col_Schulformen = add("Schulformen", SchemaDatentypen.VARCHAR, false).setDatenlaenge(255)
			.setJavaComment("Gibt an in welchen Schulformen die Fachgruppe zulässig ist");

	/** Die Definition der Tabellenspalte FarbeR */
	public final SchemaTabelleSpalte col_FarbeR = add("FarbeR", SchemaDatentypen.INT, false)
			.setJavaComment("Default-Fachgruppenfarbe (Rot-Wert)");

	/** Die Definition der Tabellenspalte FarbeG */
	public final SchemaTabelleSpalte col_FarbeG = add("FarbeG", SchemaDatentypen.INT, false)
			.setJavaComment("Default-Fachgruppenfarbe (Grün-Wert)");

	/** Die Definition der Tabellenspalte FarbeB */
	public final SchemaTabelleSpalte col_FarbeB = add("FarbeB", SchemaDatentypen.INT, false)
	...
	public final SchemaTabelleSpalte col_FuerZeugnis = add("FuerZeugnis", SchemaDatentypen.INT, false)
			.setNotNull()
	...
	public final SchemaTabelleUniqueIndex unique_Fachgruppen_UC1 = addUniqueIndex("Fachgruppen_UC1",
			col_SchildFgID);

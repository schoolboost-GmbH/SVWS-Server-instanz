...
public class Tabelle_UV_Klassen extends SchemaTabelle {
	...
	public SchemaTabelleSpalte col_Parallelitaet = add("Parallelitaet", SchemaDatentypen.VARCHAR, false).setDatenlaenge(2)
			.setNotNull()
    ...
    public SchemaTabelleSpalte col_Schuelergruppe_ID = add("Schuelergruppe_ID", SchemaDatentypen.BIGINT, false)
    		.setNotNull()
    ...
    public SchemaTabelleFremdschluessel fk_UVKlassen_Schuljahresabschnitte_FK = addForeignKey(
    ...
    public SchemaTabelleFremdschluessel fk_UVKlassen_UVStundentafeln_FK = addForeignKey(
    ...
    public SchemaTabelleFremdschluessel fk_UVKlassen_UVSchuelergruppen_FK = addForeignKey(
	...
	public SchemaTabelleUniqueIndex unique_UVKlassen_UC1 = addUniqueIndex("UVKlassen_UC1",

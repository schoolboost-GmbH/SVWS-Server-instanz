...
public class Tabelle_EigeneSchule_KAoADaten extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_Curriculum = add("Curriculum", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_Koordinator = add("Koordinator", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setNotNull()
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_Berufsorientierungsbuero = add("Berufsorientierungsbuero", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setNotNull()
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_KooperationsvereinbarungAA = add("KooperationsvereinbarungAA", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setNotNull()
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_NutzungReflexionsworkshop = add("NutzungReflexionsworkshop", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setNotNull()
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_NutzungEntscheidungskompetenzI = add("NutzungEntscheidungskompetenzI", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setNotNull()
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)
	...
	public final SchemaTabelleSpalte col_NutzungEntscheidungskompetenzII = add("NutzungEntscheidungskompetenzII", SchemaDatentypen.VARCHAR, false).setDatenlaenge(1)
			.setDefault("+")
			.setNotNull()
			.setConverter(BooleanPlusMinusDefaultPlusConverter.class)

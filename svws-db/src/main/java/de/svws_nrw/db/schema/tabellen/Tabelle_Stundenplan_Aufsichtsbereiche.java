...
public class Tabelle_Stundenplan_Aufsichtsbereiche extends SchemaTabelle {
	...
	public final SchemaTabelleFremdschluessel fk_Stundenplan_Aufsichtsbereiche_Stundenplan_FK = addForeignKey(
	...
	public final SchemaTabelleUniqueIndex unique_Stundenplan_Aufsichtsbereiche_UC1 = addUniqueIndex("Stundenplan_Aufsichtsbereiche_UC1",
			col_Stundenplan_ID,
			col_Kuerzel
	);
	...
	public Tabelle_Stundenplan_Aufsichtsbereiche() {
		...
		setJavaComment(
				"Enthält die Liste von Aufsichtsbereichen, welche im Stundenplan verwendet werden. Diese werden üblicherweise aus der Tabelle Katalog_Aufsichtsbereich übernommen und hier zwischengespeichert. Änderungen im Katalog werden nicht hierhin übernommen.");
	}

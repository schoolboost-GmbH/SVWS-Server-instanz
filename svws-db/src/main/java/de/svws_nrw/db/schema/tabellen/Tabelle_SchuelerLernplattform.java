...
public class Tabelle_SchuelerLernplattform extends SchemaTabelle {
	...
	public final SchemaTabelleSpalte col_SchuelerID = add("SchuelerID", SchemaDatentypen.BIGINT, true)
			.setNotNull()
			.setJavaComment("SchülerID für den Lernplattform-Datensatz");

	/** Die Definition der Tabellenspalte LernplattformID */
	public final SchemaTabelleSpalte col_LernplattformID = add("LernplattformID", SchemaDatentypen.BIGINT, true)
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_EinwilligungenAbgefragt = add("EinwilligungenAbgefragt", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
	...
	public final SchemaTabelleSpalte col_EinwilligungAbgefragt = add("EinwilligungAbgefragt", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
			.setConverter(Boolean01Converter.class)
			.setJavaComment("Einwilligung wurde abgefragt")
	...
	public final SchemaTabelleSpalte col_EinwilligungNutzung = add("EinwilligungNutzung", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
			.setConverter(Boolean01Converter.class)
	...
	public final SchemaTabelleSpalte col_EinwilligungAudiokonferenz = add("EinwilligungAudiokonferenz", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
			.setConverter(Boolean01Converter.class)
	...
	public final SchemaTabelleSpalte col_EinwilligungVideokonferenz = add("EinwilligungVideokonferenz", SchemaDatentypen.INT, false)
			.setDefault("0")
			.setNotNull()
			.setConverter(Boolean01Converter.class)
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerLernplattform_Schueler_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerLernplattform_Lernplattform_FK = addForeignKey(
	...
	public final SchemaTabelleFremdschluessel fk_SchuelerLernplattform_Credential_FK = addForeignKey(

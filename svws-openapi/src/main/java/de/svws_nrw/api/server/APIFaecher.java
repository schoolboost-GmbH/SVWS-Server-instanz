...
public class APIFaecher {
	...
	@Operation(summary = "Passt das Fach mit der angebenen ID an.",
			description = "Passt das Fach mit der angebenen ID an. "
					+ "Dabei wird geprüft, ob der SVWS-Benutzer die notwendige Berechtigung zum Ändern von Fächern besitzt.")
	...
	@Operation(summary = "Entfernt ein Fach.",
			description = "Entfernt ein Fach. Dabei wird geprüft, ob der SVWS-Benutzer die notwendige Berechtigung zum Löschen eines Faches hat.")
	...
	/**
	 * Die OpenAPI-Methode für das Entfernen mehrerer Fächer.
	 *
	 * @param schema    das Datenbankschema
	...
	@Operation(summary = "Entfernt mehrere Fächer.", description = "Entfernt mehrere Fächer. Dabei wird geprüft, ob alle Vorbedingungen zum Entfernen"
			+ "der Fächer erfüllt sind und der SVWS-Benutzer die notwendige Berechtigung hat.")
	...
	@ApiResponse(responseCode = "403", description = "Der SVWS-Benutzer hat keine Rechte, um Fächer zu entfernen.")
	@ApiResponse(responseCode = "500", description = "Unspezifizierter Fehler (z.B. beim Datenbankzugriff)")
	public Response deleteFaecher(@PathParam("schema") final String schema, @RequestBody(description = "Die IDs der zu löschenden Fächer", required = true,
	...
	public Response getKatalogBilingualeSprachenEintrag(@PathParam("schema") final String schema, @PathParam("id") final long id,
			@Context final HttpServletRequest request) {
	...
	@ApiResponse(responseCode = "200", description = "Der Katalog der Sprachprüfungsniveaus.",
			content = @Content(mediaType = "application/json",
					array = @ArraySchema(schema = @Schema(implementation = SprachpruefungsniveauKatalogEintrag.class))))
	@ApiResponse(responseCode = "403", description = "Der SVWS-Benutzer hat keine gültige Anmeldung.")
	@ApiResponse(responseCode = "404", description = "Keine Fachgruppen gefunden.")
	...
	@ApiResponse(responseCode = "200", description = "Der Katalog der Sprachreferenzniveaus.",
			content = @Content(mediaType = "application/json",
					array = @ArraySchema(schema = @Schema(implementation = SprachreferenzniveauKatalogEintrag.class))))
	@ApiResponse(responseCode = "403", description = "Der SVWS-Benutzer hat keine gültige Anmeldung.")
	@ApiResponse(responseCode = "404", description = "Keine Fachgruppen gefunden.")
	...
	@Operation(summary = "Setzte eine Sortierung für die Fächer auf eine Standard-Sortierung für die Sekundarstufe II.",
			description = "Setzte eine Sortierung für die Fächer auf eine Standard-Sortierung für die Sekundarstufe II."
					+ "Dabei wird geprüft, ob der SVWS-Benutzer die notwendige Berechtigung zum Anpassen von Fächerdaten besitzt.")

...
public final class DTOSchueler {
	...
	/** Die Datenbankabfrage für DTOs anhand des Attributes idStatus */
	public static final String QUERY_BY_IDSTATUS = "SELECT e FROM DTOSchueler e WHERE e.idStatus = ?1";

	/** Die Datenbankabfrage für DTOs anhand einer Liste von Werten des Attributes idStatus */

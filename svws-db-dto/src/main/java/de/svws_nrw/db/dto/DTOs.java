...
import de.svws_nrw.db.dto.current.uv.DTOUvStundenplanErgebnis;
import de.svws_nrw.db.dto.current.uv.DTOUvStundenplanErgebnisUnterrichtLehrer;
import de.svws_nrw.db.dto.current.uv.DTOUvStundenplanErgebnisUnterrichtRaum;
import de.svws_nrw.db.dto.current.uv.DTOUvStundenplanErgebnisUnterrichtZeitraster;
import de.svws_nrw.db.dto.current.uv.DTOUvStundenplanKonfiguration;
import de.svws_nrw.db.dto.current.uv.DTOUvStundenplanRegel;
import de.svws_nrw.db.dto.current.uv.DTOUvStundenplanRegelparameter;
     ...
     */
     private static HashMap<String, Class<? extends Object>> getMapDTOName2DTOClass() {
         if (mapDTOName2DTOClass == null) {
             ...
             mapDTOName2DTOClass.put(DTOUvKurs.class.getSimpleName(), DTOUvKurs.class);
             mapDTOName2DTOClass.put(DTOUvLehrer.class.getSimpleName(), DTOUvLehrer.class);
             mapDTOName2DTOClass.put(DTOUvLehrerAnrechnungsstunden.class.getSimpleName(), DTOUvLehrerAnrechnungsstunden.class);
             mapDTOName2DTOClass.put(DTOUvLehrerPflichtstundensoll.class.getSimpleName(), DTOUvLehrerPflichtstundensoll.class);
             mapDTOName2DTOClass.put(DTOUvLerngruppe.class.getSimpleName(), DTOUvLerngruppe.class);
             mapDTOName2DTOClass.put(DTOUvLerngruppeSchiene.class.getSimpleName(), DTOUvLerngruppeSchiene.class);
             mapDTOName2DTOClass.put(DTOUvLerngruppenLehrer.class.getSimpleName(), DTOUvLerngruppenLehrer.class);
             mapDTOName2DTOClass.put(DTOUvPlanungsabschnitt.class.getSimpleName(), DTOUvPlanungsabschnitt.class);
             mapDTOName2DTOClass.put(DTOUvPlanungsabschnittLehrer.class.getSimpleName(), DTOUvPlanungsabschnittLehrer.class);
             mapDTOName2DTOClass.put(DTOUvPlanungsabschnittSchueler.class.getSimpleName(), DTOUvPlanungsabschnittSchueler.class);
             mapDTOName2DTOClass.put(DTOUvPlanungsabschnittZeitraster.class.getSimpleName(), DTOUvPlanungsabschnittZeitraster.class);
             mapDTOName2DTOClass.put(DTOUvRaum.class.getSimpleName(), DTOUvRaum.class);
             mapDTOName2DTOClass.put(DTOUvSchiene.class.getSimpleName(), DTOUvSchiene.class);
             mapDTOName2DTOClass.put(DTOUvSchienenConstraintJahrgang.class.getSimpleName(), DTOUvSchienenConstraintJahrgang.class);
             mapDTOName2DTOClass.put(DTOUvSchuelergruppe.class.getSimpleName(), DTOUvSchuelergruppe.class);
             mapDTOName2DTOClass.put(DTOUvSchuelergruppeConstraintJahrgang.class.getSimpleName(), DTOUvSchuelergruppeConstraintJahrgang.class);
             mapDTOName2DTOClass.put(DTOUvSchuelergruppeConstraintSchuelergruppe.class.getSimpleName(), DTOUvSchuelergruppeConstraintSchuelergruppe.class);
             mapDTOName2DTOClass.put(DTOUvSchuelergruppeSchueler.class.getSimpleName(), DTOUvSchuelergruppeSchueler.class);
             mapDTOName2DTOClass.put(DTOUvStundenplanErgebnis.class.getSimpleName(), DTOUvStundenplanErgebnis.class);
             mapDTOName2DTOClass.put(DTOUvStundenplanErgebnisUnterrichtLehrer.class.getSimpleName(), DTOUvStundenplanErgebnisUnterrichtLehrer.class);
             mapDTOName2DTOClass.put(DTOUvStundenplanErgebnisUnterrichtRaum.class.getSimpleName(), DTOUvStundenplanErgebnisUnterrichtRaum.class);
             mapDTOName2DTOClass.put(DTOUvStundenplanErgebnisUnterrichtZeitraster.class.getSimpleName(), DTOUvStundenplanErgebnisUnterrichtZeitraster.class);
             mapDTOName2DTOClass.put(DTOUvStundenplanKonfiguration.class.getSimpleName(), DTOUvStundenplanKonfiguration.class);
             mapDTOName2DTOClass.put(DTOUvStundenplanRegel.class.getSimpleName(), DTOUvStundenplanRegel.class);
             mapDTOName2DTOClass.put(DTOUvStundenplanRegelparameter.class.getSimpleName(), DTOUvStundenplanRegelparameter.class);
             mapDTOName2DTOClass.put(DTOUvStundentafel.class.getSimpleName(), DTOUvStundentafel.class);
             mapDTOName2DTOClass.put(DTOUvStundentafelFach.class.getSimpleName(), DTOUvStundentafelFach.class);
             mapDTOName2DTOClass.put(DTOUvUnterricht.class.getSimpleName(), DTOUvUnterricht.class);
             mapDTOName2DTOClass.put(DTOUvUnterrichtRaum.class.getSimpleName(), DTOUvUnterrichtRaum.class);
             mapDTOName2DTOClass.put(DTOUvUnterrichteLerngruppenlehrer.class.getSimpleName(), DTOUvUnterrichteLerngruppenlehrer.class);
             mapDTOName2DTOClass.put(DTOUvZeitraster.class.getSimpleName(), DTOUvZeitraster.class);
             mapDTOName2DTOClass.put(DTOUvZeitrasterEintrag.class.getSimpleName(), DTOUvZeitrasterEintrag.class);
             mapDTOName2DTOClass.put(DTOUv_PlanungsabschnittZeitraster_Constraint_Jahrgang.class.getSimpleName(), DTOUv_PlanungsabschnittZeitraster_Constraint_Jahrgang.class);
     ...
     */
     private static HashMap<String, Class<? extends Object>> getMapTablename2DTOClass() {
         if (mapTablename2DTOClass == null) {
             ...
             mapTablename2DTOClass.put("UV_Kurse", DTOUvKurs.class);
             mapTablename2DTOClass.put("UV_Lehrer", DTOUvLehrer.class);
             mapTablename2DTOClass.put("UV_LehrerAnrechnungsstunden", DTOUvLehrerAnrechnungsstunden.class);
             mapTablename2DTOClass.put("UV_LehrerPflichtstundensoll", DTOUvLehrerPflichtstundensoll.class);
             mapTablename2DTOClass.put("UV_Lerngruppen", DTOUvLerngruppe.class);
             mapTablename2DTOClass.put("UV_Lerngruppen_Schienen", DTOUvLerngruppeSchiene.class);
             mapTablename2DTOClass.put("UV_Lerngruppen_Lehrer", DTOUvLerngruppenLehrer.class);
             mapTablename2DTOClass.put("UV_Planungsabschnitte", DTOUvPlanungsabschnitt.class);
             mapTablename2DTOClass.put("UV_Planungsabschnitte_Lehrer", DTOUvPlanungsabschnittLehrer.class);
             mapTablename2DTOClass.put("UV_Planungsabschnitte_Schueler", DTOUvPlanungsabschnittSchueler.class);
             mapTablename2DTOClass.put("UV_Planungsabschnitte_Zeitraster", DTOUvPlanungsabschnittZeitraster.class);
             mapTablename2DTOClass.put("UV_Raeume", DTOUvRaum.class);
             mapTablename2DTOClass.put("UV_Schienen", DTOUvSchiene.class);
             mapTablename2DTOClass.put("UV_Schienen_Constraint_Jahrgaenge", DTOUvSchienenConstraintJahrgang.class);
             mapTablename2DTOClass.put("UV_Schuelergruppen", DTOUvSchuelergruppe.class);
             mapTablename2DTOClass.put("UV_Schuelergruppen_Constraint_Jahrgaenge", DTOUvSchuelergruppeConstraintJahrgang.class);
             mapTablename2DTOClass.put("UV_Schuelergruppen_Constraint_Schuelergruppen", DTOUvSchuelergruppeConstraintSchuelergruppe.class);
             mapTablename2DTOClass.put("UV_Schuelergruppen_Schueler", DTOUvSchuelergruppeSchueler.class);
             mapTablename2DTOClass.put("UV_StundenplanErgebnisse", DTOUvStundenplanErgebnis.class);
             mapTablename2DTOClass.put("UV_StundenplanErgebnisse_Unterricht_Lehrer", DTOUvStundenplanErgebnisUnterrichtLehrer.class);
             mapTablename2DTOClass.put("UV_StundenplanErgebnisse_Unterricht_Raeume", DTOUvStundenplanErgebnisUnterrichtRaum.class);
             mapTablename2DTOClass.put("UV_StundenplanErgebnisse_Unterricht_Zeitraster", DTOUvStundenplanErgebnisUnterrichtZeitraster.class);
             mapTablename2DTOClass.put("UV_StundenplanKonfigurationen", DTOUvStundenplanKonfiguration.class);
             mapTablename2DTOClass.put("UV_StundenplanRegeln", DTOUvStundenplanRegel.class);
             mapTablename2DTOClass.put("UV_StundenplanRegelparameter", DTOUvStundenplanRegelparameter.class);
             mapTablename2DTOClass.put("UV_Stundentafeln", DTOUvStundentafel.class);
             mapTablename2DTOClass.put("UV_Stundentafeln_Faecher", DTOUvStundentafelFach.class);
             mapTablename2DTOClass.put("UV_Unterrichte", DTOUvUnterricht.class);
             mapTablename2DTOClass.put("UV_Unterrichte_Raeume", DTOUvUnterrichtRaum.class);
             mapTablename2DTOClass.put("UV_Unterrichte_Lerngruppenlehrer", DTOUvUnterrichteLerngruppenlehrer.class);
             mapTablename2DTOClass.put("UV_Zeitraster", DTOUvZeitraster.class);
             mapTablename2DTOClass.put("UV_ZeitrasterEintraege", DTOUvZeitrasterEintrag.class);
             mapTablename2DTOClass.put("UV_PlanungsabschnitteZeitraster_Constraint_Jahrgaenge", DTOUv_PlanungsabschnittZeitraster_Constraint_Jahrgang.class);
